    ...
    <div class="col-sm-8 header-title p-0">
        <div class="media">
            ...
            <div class="media-body">
                ...
                <small>Halaman ini digunakan untuk menampilkan kecukupan Dosen pada Universitas Islam Jember</small>
            </div>
        </div>
    </div>
@endsection
        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="fs-17 font-weight-600 mb-0">Kecukupan Dosen Universitas Islam Jember</h6>
                    </div>
                </div>
            </div>
            <div class="card-body">
                        ...
                        <table class="table table-striped table-bordered table-hover" id="table">
                            <thead style="font-weight: bold">
                                <tr>
                                    ...
                                    <td rowspan="2" style="text-align: center; vertical-align: middle">Unit
                                        Pengelola<br />(Fakultas/Departemen/Jurusan)
                                    </td>
                                ...
                                @if (sizeof($dosen) > 0)
                                    <tr>
                                        ...
                                        <td style="text-align: center; font-weight: bold"><a
                                                href="/hrd/data-kepegawaian/rekap-sdm/detail-dosen/kecukupan/00000000-0000-0000-0000-000000000000/1">{{ $dosen[0]->total_doktor }}</a>
                                        </td>
                                        <td style="text-align: center; font-weight: bold"><a
