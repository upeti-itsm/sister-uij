    ...
    <div class="col-sm-8 header-title p-0">
        <div class="media">
            ...
            <div class="media-body">
                <h1 class="font-weight-bold">Tambah Data Pegawai</h1>
                <small>Halaman ini digunakan untuk menambah data pegawai baru</small>
            </div>
        </div>
    </div>
@endsection
@section('body-content')
    ...
    <div class="col-md-12 mt-4">
        <form action="{{route('hrd.data_kepegawaian.list_data_pegawai.store')}}" method="POST"
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="card-body text-center">
                                        <a class="avatar avatar-xl card-avatar card-avatar-top mb-5">
                                            <img id="user_profile"
                                                 style="width: 150%!important; height: 150%!important;"
                                                 src="{{asset('files/profile/'.\Illuminate\Support\Facades\Session::get('user')->id_personal)}}"
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <input type="text" required name="no_ktp" value="{{old('no_ktp')}}"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2" name="jenis_kelamin" required>
                                                    ...
                                                    <option value="lk"
                                                            @if(old('jenis_kelamin') == "lk") selected @endif>Laki-Laki
                                                    </option>
                                                    <option value="pr"
                                                            @if(old('jenis_kelamin') == "pr") selected @endif>Perempuan
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2" name="jenis_bank" required>
                                                    ...
                                                    <option value="1"
                                                            @if(old('jenis_bank') == "1") selected @endif>Bank Rakyat Indonesia
                                                    </option>
                                                    <option value="2"
                                                            @if(old('jenis_bank') == "2") selected @endif>Bank Syariah Indonesia
                                                    </option>
                                                    <option value="3"
                                                            @if(old('jenis_bank') == "3") selected @endif>Bank Jatim Syariah
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <select class="form-control select2" name="id_agama">
                                            ...
                                            @foreach($agama AS $item)
                                                <option value="{{$item->id_agama}}"
                                                        @if(old('id_agama') == $item->id_agama) selected @endif>{{$item->agama}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="hidden" class="form-control" id="tgl_aktif" required
                                       placeholder="Tanggal Lahir" name="tgl_aktif">
                            </div>
                        </div>
                        @if($jenis_karyawan == 1)
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="jenis_karyawan">
                                        ...
                                        <option value="1" @if(old('jenis_karyawan') == 1) selected @endif>Dosen Tetap
                                        </option>
                                        <option value="2" @if(old('jenis_karyawan') == 2) selected @endif>Dosen LB
                                        </option>
                                        <option value="3" @if(old('jenis_karyawan') == 3) selected @endif>Dosen
                                            Praktisi
                                        </option>
                                        <option value="6" @if(old('jenis_karyawan') == 6) selected @endif>Dosen Dpk
                                        </option>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" id="home_base"
                                        ...
                                        @foreach($prodi AS $item)
                                            <option
                                                value="{{$item->kd_program_studi}}">{{$item->jenjang_didik.'-'.$item->nama_program_studi}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" id="status_sertifikasi"
                                        ...
                                        <option value="0" @if(old('status_sertifikasi') == 0) selected @endif>Belum
                                            Sertifikasi
                                        </option>
                            ...
                            <div class="col-md-4" style="text-align: left; display: none" id="unggah_sertifikat_area">
                                <div class="form-group">
                        ...
                        @else
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="text-muted">Jenis Karyawan <small
                                ...
                                <select class="form-control select2" name="golongan">
                                    ...
                                    @foreach($golongan AS $item)
                                        <option value="{{$item->id_golongan}}"
                                                @if(old('golongan') == $item->id_golongan) selected @endif>{{$item->golongan}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="jabatan_struktural">
                                    <option value="0">-- Pilih Jabatan Struktural --</option>
                                    @foreach($jabatan_struktural AS $item)
                                        <option value="{{$item->id_jabatan_struktural}}"
                                                @if(old('jabatan_struktural') == $item->id_jabatan_struktural) selected @endif>{{$item->jabatan_struktural}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group" style="text-align: left">
                                ...
                                <div class="custom-file">
                                    <input type="file" accept=".pdf"
                                           class="custom-file-input"
                                           id="file_sk_jabatan_struktural" name="file_sk_jabatan_struktural">
                                    <label class="custom-file-label" for="customFile">Pilih file</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="jabatan_fungsional">
                                    <option value="0">-- Pilih Jabatan Fungsional --</option>
                                    @foreach($jabatan_fungsional AS $item)
                                        <option value="{{$item->id_jabatan_fungsional}}"
                                                @if(old('jabatan_fungsional') == $item->id_jabatan_fungsional) selected @endif>{{$item->jabatan_fungsional}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group" style="text-align: left">
                                ...
                                <div class="custom-file">
                                    <input type="file" accept=".pdf"
                                           class="custom-file-input"
                                           id="file_sk_jabatan_fungsional" name="file_sk_jabatan_fungsional">
                                    <label class="custom-file-label" for="customFile">Pilih file</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" required name="pendidikan_terakhir">
                                    <option value="">-- Pilih Pendidikan Terakhir --</option>
                                    @foreach($pendidikan AS $item)
                                        <option value="{{$item->kd_pendidikan_terakhir}}"
                                                @if(old('pendidikan_terakhir') == $item->kd_pendidikan_terakhir) selected @endif>{{$item->pendidikan}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group" style="text-align: left">
                                ...
                                <div class="custom-file">
                                    <input type="file" accept=".pdf"
                                           class="custom-file-input"
                                           required id="file_ijazah" name="file_ijazah">
                                    <label class="custom-file-label" for="customFile">Pilih file</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" id="status_menikah" name="status_menikah" required>
                                    ...
                                    <option value="1" @if(old('status_menikah') == 1) selected @endif>Belum Kawin
                                    </option>
                                    <option value="2" @if(old('status_menikah') == 2) selected @endif>Kawin</option>
                                    <option value="3" @if(old('status_menikah') == 3) selected @endif>Cerai Hidup
                                    </option>
                                    <option value="4" @if(old('status_menikah') == 4) selected @endif>Cerai Mati
                                    </option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group" style="text-align: left">
                                ...
                                <div class="custom-file">
                                    <input type="file" accept=".pdf"
                                           class="custom-file-input"
                                           required id="file_kk" name="file_kk">
                                    <label class="custom-file-label" for="customFile">Pilih file</label>
                                </div>
                            </div>
                        </div>
...
@push('scripts')
    ...
    <script src="{{asset('adminpage/own-js/hrd_page/data_kepegawaian/create_data_pegawai.js')}}"></script>
@endpush
