                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-4">
                                    <input type="hidden" id="id_personal" name="id"
                                        value="{{ $karyawan->id_personal }}">
                                    ...
                                    <div class="card-body text-center">
                                        ...
                                        <button type="button" class="btn btn-block btn-outline-success mb-2"
                                            id="btn_pilih_foto"><span class="spinner-border spinner-border-sm text-info"
                                                style="display: none" id="photo_profile_loading" role="status"></span>Pilih
                                            Foto
                                        </button>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <input type="text" class="form-control"
                                                            placeholder="Nama Sesuai KTP" name="nama" required
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="alamat" required placeholder="Alamat Lengkap Sesuai KTP">{{ old('alamat') ? old('alamat') : $karyawan->alamat }}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="id_agama">
                                            ...
                                            @foreach ($agama as $item)
                                                <option value="{{ $item->id_agama }}"
                                                    @if (old('id_agama') == $item->id_agama || $karyawan->id_agama == $item->id_agama) selected @endif>{{ $item->agama }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        @else
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="jenis_karyawan">
                                        ...
                                        <option value="1" @if (old('jenis_karyawan') == 1 || $karyawan->id_jenis_karyawan == 1) selected @endif>
                                            Dosen Tetap
                                        </option>
                                        <option value="2" @if (old('jenis_karyawan') == 2 || $karyawan->id_jenis_karyawan == 2) selected @endif>
                                            Dosen LB
                                        </option>
                                        <option value="3" @if (old('jenis_karyawan') == 3 || $karyawan->id_jenis_karyawan == 3) selected @endif>
                                            Dosen Praktisi
                                        </option>
                                        <option value="6" @if (old('jenis_karyawan') == 6 || $karyawan->id_jenis_karyawan == 6) selected @endif>
                                            Dosen Dpk
                                        </option>
                                    </select>
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="text-muted">Home Base <span class="text-danger">*</span></label>
                                    <select class="form-control select2" id="home_base" name="home_base" required>
                                        <option value="0">Tidak Ada Homebase</option>
                                        @foreach ($prodi as $item)
                                            <option value="{{ $item->kd_program_studi }}"
                                                @if (old('home_base', $karyawan->kd_program_studi) == $item->kd_program_studi) selected @endif>
                                                {{ $item->jenjang_didik . '-' . $item->nama_program_studi }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" id="status_sertifikasi"
                                        name="list_sertifikasi[]" required multiple>
                                        <option value="0" @if (in_array('0', $selected_sertifikasi)) selected @endif>Belum
                                            Sertifikasi</option>
                                        <option value="1" @if (in_array('1', $selected_sertifikasi)) selected @endif>Pekerti
                                        </option>
                                        <option value="2" @if (in_array('2', $selected_sertifikasi)) selected @endif>Serdos
                                        </option>
                                        <option value="3" @if (in_array('3', $selected_sertifikasi)) selected @endif>
                                            Profesional</option>
                                        <option value="4" @if (in_array('4', $selected_sertifikasi)) selected @endif>BNSP
                                        </option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-4"
                                @if (old('status_sertifikasi', $karyawan->sts_sertifikasi) != 1) style="text-align: left; display: none" @endif
                                id="unggah_sertifikat_area">
                                <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="pangkat">
                                    ...
                                    <option value="2" @if (old('pangkat') == 2 || $karyawan->id_pangkat == 2) selected @endif>Penata
                                    </option>
                                    <option value="3" @if (old('pangkat') == 3 || $karyawan->id_pangkat == 3) selected @endif>Pembina
                                    </option>
                                </select>
                            </div>
                        </div>
                                ...
                                <select class="form-control select2" name="golongan">
                                    ...
                                    @foreach ($golongan as $item)
                                        <option value="{{ $item->id_golongan }}"
                                            @if (old('golongan') == $item->id_golongan || $karyawan->id_golongan == $item->id_golongan) selected @endif>{{ $item->golongan }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                                ...
                                <select class="form-control select2" name="jastruk">
                                    ...
                                    @foreach ($jabatan_struktural as $item)
                                        <option value="{{ $item->id_jabatan_struktural }}"
                                            @if (old('jabatan_struktural') == $item->id_jabatan_struktural ||
                                                    $karyawan->id_jabatan_struktural == $item->id_jabatan_struktural) selected @endif>
                                            {{ $item->jabatan_struktural }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                                ...
                                <select class="form-control select2" name="jafung">
                                    ...
                                    @foreach ($jabatan_fungsional as $item)
                                        <option value="{{ $item->id_jabatan_fungsional }}"
                                            @if (old('jabatan_fungsional') == $item->id_jabatan_fungsional ||
                                                    $karyawan->id_jabatan_fungsional == $item->id_jabatan_fungsional) selected @endif>
                                            {{ $item->jabatan_fungsional }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                                ...
                                <select class="form-control select2" required name="pendidikan">
                                    ...
                                    @foreach ($pendidikan as $item)
                                        <option value="{{ $item->kd_pendidikan_terakhir }}"
                                            @if (old('pendidikan_terakhir') == $item->kd_pendidikan_terakhir ||
                                                    $karyawan->kd_pendidikan == $item->kd_pendidikan_terakhir) selected @endif>{{ $item->pendidikan }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" required name="unit_kerja">
                                    <option value="" disabled @if (!old('unit_kerja') && is_null($karyawan->id_unit_kerja)) selected @endif>--
                                        Pilih Unit Kerja --</option>
                                    @foreach ($unit_kerja as $item)
                                        <option value="{{ $item->id_unit_kerja }}"
                                            @if (old('unit_kerja') == $item->id_unit_kerja || $karyawan->id_unit_kerja == $item->id_unit_kerja) selected @endif>{{ $item->unit_kerja }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" id="status_menikah" name="status_menikah" required>
                                    ...
                                    <option value="1" @if (old('status_menikah') == 1 || $karyawan->id_status_pernikahan == 1) selected @endif>
                                        Belum Kawin
                                    </option>
                                    <option value="2" @if (old('status_menikah') == 2 || $karyawan->id_status_pernikahan == 2) selected @endif>
                                        Kawin
                                    </option>
                                    <option value="3" @if (old('status_menikah') == 3 || $karyawan->id_status_pernikahan == 3) selected @endif>
                                        Cerai Hidup
                                    </option>
                                    <option value="4" @if (old('status_menikah') == 4 || $karyawan->id_status_pernikahan == 4) selected @endif>
                                        Cerai Mati
                                    </option>
                                </select>
                            </div>
