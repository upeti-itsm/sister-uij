...
@section('content-header')
    <nav aria-label="breadcrumb" class="col-sm-4 order-sm-last mb-3 mb-sm-0 p-0 ">
        <ol class="breadcrumb d-inline-flex font-weight-600 fs-13 bg-white mb-0 float-sm-right">
            <li class="breadcrumb-item">Akadmik</li>
    ...
    <div class="col-sm-8 header-title p-0">
        <div class="media">
            ...
            <div class="media-body">
                <h1 class="font-weight-bold">Sertifikat Laboratorium Komputer</h1>
                <small>Halaman ini digunakan untuk validasi pengajuan seritifikat laboratorium komputer</small>
            </div>
        </div>
    </div>
@endsection
        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="fs-17 font-weight-600 mb-0">Sertifikat Laboratorium Komputer</h6>
                    </div>
                </div>
            </div>
            <div class="card-body">
...
@push('scripts')
    ...
    <script src="{{asset('adminpage/own-js/admin_uptti/akademik/sertifikat_labkom.js')}}"></script>
@endpush
