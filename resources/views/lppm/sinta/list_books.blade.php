...
@section('content-header')
    <nav aria-label="breadcrumb" class="col-sm-4 order-sm-last mb-3 mb-sm-0 p-0 ">
        <ol class="breadcrumb d-inline-flex font-weight-600 fs-13 bg-white mb-0 float-sm-right">
            ...
            <li class="breadcrumb-item active">List Books Docs</li>
        </ol>
    </nav>
    <div class="col-sm-8 header-title p-0">
        <div class="media">
            ...
            <div class="media-body">
                <h1 class="font-weight-bold">List Books Docs</h1>
        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="fs-17 font-weight-600 mb-0">List Books Docs</h6>
                    </div>
                    <div class="text-right">
                        <div class="actions">
                            <button class="btn btn-danger-soft btn-sync-ulang mr-2" id="btn-sync"
                                    title="Sync Doc Books"><i
                                    class="fas fa-user-lock"></i> Sync Books
                            </button>
                        </div>
                    </div>
                </div>
...
@push('scripts')
    ...
    <script src="{{asset('adminpage/own-js/lppm/sinta/list_books_docs.js')}}"></script>
@endpush
