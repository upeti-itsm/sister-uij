    ...
    <div class="col-sm-8 header-title p-0">
        <div class="media">
            ...
            <div class="media-body">
                <h1 class="font-weight-bold">List Author</h1>
                <small>Halaman ini digunakan untuk menampilkan data author yang sudah masuk ke sinta</small>
            </div>
        </div>
    </div>
@endsection
        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="fs-17 font-weight-600 mb-0">List Author</h6>
                    </div>
                    <div class="text-right">
                        <div class="actions">
                            <button class="btn btn-danger-soft btn-sync-ulang mr-2" id="btn-sync"
                                    title="Sync Authors"><i
                                    class="fas fa-user-lock"></i> Sync Authors
                            </button>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" id="kd_prodi">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover" id="table">
                            ...
                            <tr>
                                ...
                                <th class="text-center">Scopus & WoS</th>
                                <th class="text-center">Garuda & Google Scholar</th>
                            </tr>
                            </thead>
                            <tbody>
                            </tbody>
...
@push('scripts')
    ...
    <script src="{{asset('adminpage/own-js/lppm/sinta/list_author.js')}}"></script>
@endpush
