...
<body>
    <!-- Page 1: Surat Keterangan Aktif Kuliah -->
    <div class="page page-break">
        ...
        <div class="body-text">
            Adalah benar mahasiswa aktif pada Semester {{ $mahasiswa->semester_aktif ?? 'Gasal / Genap' }}
            tahun Akademik {{ $mahasiswa->tahun_akademik ?? '…../…….' }}.
            Surat keterangan ini diberikan kepada mahasiswa yang bersangkutan untuk
    ...
    <!-- Page 2: Permohonan Surat Aktif Kuliah -->
    <div class="page">
        <div class="header">
            <div class="header-logo">
                @if (!empty($logo))
        ...
        <table class="hal-table">
            <tr>
                <td class="hal-label">H a l</td>
                <td class="hal-sep">:</td>
                <td>Permohonan surat aktif kuliah</td>
            </tr>
        </table>
        ...
        <div class="body-text">Assalamu'alaikum Wr. Wb.</div>
        ...
        <div class="body-text">
            Bermaksud mengajukan permohonan untuk dibuatkan surat keterangan aktif kuliah
            pada Semester {{ $mahasiswa->semester_aktif ?? 'Gasal / Genap' }}
            tahun akademik {{ $mahasiswa->tahun_akademik ?? '……… /…….' }}.
        </div>

        <div class="body-text">
            Surat keterangan ini akan saya gunakan untuk:
        </div>
        ...
        <div class="body-text">
            Demikian permohonan ini saya sampaikan, atas perhatian dan dikabulkannya
