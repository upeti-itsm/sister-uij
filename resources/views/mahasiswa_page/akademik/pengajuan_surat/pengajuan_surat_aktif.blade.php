    ...
    <div class="col-sm-8 header-title p-0">
        <div class="media">
            ...
            <div class="media-body">
                ...
                <small>Ajukan surat aktif kuliah dan pantau status persetujuannya.</small>
            </div>
        </div>
    </div>
@endsection
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Ajukan Surat Aktif</h5>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{ $user->nama_prodi ?? '-' }}"
                                        readonly>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"
                                        value="{{ $semesterAktif->tahun_akademik ?? '-' }}" readonly>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Keperluan <span class="text-danger">*</span></label>
                                    <textarea class="form-control" name="keperluan" rows="3" placeholder="Tuliskan keperluan surat aktif..."></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
...
@push('scripts')
    ...
    <script src="{{ asset('adminpage/own-js/mahasiswa_page/akademik/pengajuan_surat/pengajuan_surat_aktif.js') }}"></script>
@endpush
