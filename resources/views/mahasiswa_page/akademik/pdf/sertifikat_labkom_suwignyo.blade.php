...
<head>
    ...
    <style>
        ...
        body {
            background-image: url("/var/www/html/sipadu/public/image/sertifikat_labkom/sertifikat-suwignyo.png");
...
<p style="padding-top: 3px; text-align: center; line-height: 1; font-size: 18px;"><i>Diberikan kepada :</i></p>
<p style="text-align: center; font-size: 20px; line-height: 0.7; font-weight: bold; ">{{$sertifikat->nama_mahasiswa}} </p>
<p style="padding-top: 3px; text-align: center; line-height: 0.7; font-size: 18px;"><i>Tempat, Tanggal Lahir : </i></p>
<p style="text-align: center; font-size: 20px; line-height: 0.7; font-weight: bold;">{{$sertifikat->tempat_lahir}}
