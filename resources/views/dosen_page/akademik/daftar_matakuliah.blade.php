    ...
    <div class="col-sm-8 header-title p-0">
        <div class="media">
            ...
            <div class="media-body">
                ...
                <small>Halaman ini digunakan monitoring daftar matakuliah yang diampu masing-masing dosen dan pengelolaan
                    kriteria penilaian</small>
            </div>
        </div>
    </div>
@endsection
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <small class="text-muted">
                            ...
                            Klik tombol <span class="badge badge-primary"><i class="fas fa-cogs"></i></span> untuk mengelola
                            kriteria penilaian
                        </small>
                    </div>
                </div>
...
@section('modal')
    ...
    <div class="modal fade" id="modalKriteria" tabindex="-1" role="dialog" aria-labelledby="modalKriteriaLabel"
        aria-hidden="true">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="select2 form-control" id="id_kriteria" name="id_kriteria">
                                                @foreach ($kriteria as $item)
                                                    <option value="{{ $item->id_kriteria_penilaian }}">
                                                        {{ $item->kriteria_penilaian }}</option>
                                                @endforeach
                    ...
                    <div class="card">
                        <div class="card-header bg-light">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <small class="text-muted">
                                    <i class="fas fa-info-circle mr-1"></i>Klik tombol <span
                                        class="badge badge-danger badge-sm"><i class="fas fa-trash"></i></span> untuk
                                    menghapus kriteria
                                </small>
                            </div>
                        </div>
