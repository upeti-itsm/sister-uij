    ...
    <div class="col-sm-8 header-title p-0">
        <div class="media">
            ...
            <div class="media-body">
                <h1 class="font-weight-bold">Persetujuan Surat Cuti (Dosen Pembimbing)</h1>
                <small>Validasi pengajuan surat cuti dari mahasiswa bimbingan.</small>
            </div>
        </div>
    </div>
@endsection
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <th>Tahun Akademik</th>
                            <td id="detail-dosen-tahun-akademik">-</td>
                        </tr>
                        <tr>
                            <th>Tanggal Ajuan</th>
...
@push('scripts')
    ...
    <script src="{{ asset('adminpage/own-js/dosen_page/akademik/pengajuan_surat/pengajuan_surat_cuti.js') }}"></script>
@endpush
