    ...
    <div class="col-sm-8 header-title p-0">
        <div class="media">
            ...
            <div class="media-body">
                ...
                <small>Halaman ini digunakan monitoring daftar mahasiswa yang menjadi perwalian masing-masing dosen</small>
            </div>
        </div>
    </div>
@endsection
                                        ...
                                        <div class="col-md-7">
                                            <select class="select2 form-control" id="semester">
                                                @foreach($semester AS $item)
                                                    <option value="{{$item->id_semester}}">{{$item->nama_tahun_akademik}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover" id="table">
                            ...
                            <tr>
                                ...
                                <th class="text-center">Nama Mahasiswa (NIM)</th>
                                <th class="text-center">Prodi Asal</th>
                                <th class="text-center">Status Kuesioner</th>
                                <th class="text-center">Status SKPI</th>
                            </tr>
                            </thead>
                            <tbody></tbody>
                        </table>
...
@push('scripts')
    ...
    <script src="{{asset('adminpage/own-js/dosen_page/akademik/perwalian/list_mahasiswa.js')}}"></script>
@endpush
