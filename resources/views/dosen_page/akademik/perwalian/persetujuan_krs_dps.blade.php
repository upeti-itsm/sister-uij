...
@section('content-header')
    ...
    <div class="col-sm-8 header-title p-0">
        <div class="media">
            <div class="header-icon text-success mr-3"><i class="fas fa-check-circle"></i></div>
            <div class="media-body">
                <h1 class="font-weight-bold">Persetujuan KRS Mahasiswa</h1>
                <small>Halaman ini digunakan untuk menyetujui KRS mahasiswa bimbingan</small>
            </div>
        </div>
    </div>
@endsection
...
@section('body-content')
        ...
        <div class="alert alert-info">
            <div class="row align-items-center">
                ...
                <div class="col-md-11">
                    <div class="row">
                        <div class="col-md-3">
                            <h6 class="font-weight-bold mb-1">Total Mahasiswa Bimbingan</h6>
    ...
    <div class="col-md-3">
        <div class="card card-stats statistic-box mb-4">
            ...
            <div class="card-footer p-1">
                <div class="stats">
                    <i class="fas fa-hourglass-half mr-2 ml-2"></i>Persetujuan
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-3">
        <div class="card card-stats statistic-box mb-4">
            ...
            <div class="card-footer p-1">
                <div class="stats">
                    <i class="fas fa-thumbs-up mr-2 ml-2"></i>DPS
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="card card-stats statistic-box mb-4">
            ...
            <div class="card-footer p-1">
                <div class="stats">
                    <i class="fas fa-flag-checkered mr-2 ml-2"></i>Disetujui Kaprodi
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="fs-17 font-weight-600 mb-0">Daftar KRS Mahasiswa Bimbingan</h6>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        <select class="form-control" id="filter-status">
                            ...
                            <option value="2">Disetujui DPS</option>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover" id="table-krs-dps">
        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <!-- Komentar DPS -->
                    <div class="row mt-3" id="section-komentar">
                        <div class="col-md-12">
                            <h6 class="font-weight-bold text-primary mb-2">Komentar DPS</h6>
                            <div class="alert alert-warning" id="detail-komentar-dps">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header bg-success text-white">
                    <h5 class="modal-title">
                        <i class="fas fa-check-circle"></i> Persetujuan KRS
                    </h5>
                    <button type="button" class="close text-white" data-dismiss="modal">
                        <span>&times;</span>
                    </button>
                ...
                <div class="modal-body">
                    ...
                    <div class="alert alert-warning mb-0">
                        ...
                        <strong>Perhatian:</strong> Setelah KRS disetujui, mahasiswa tidak dapat mengubah KRS lagi dan akan diteruskan ke Ketua Program Studi untuk persetujuan final.
                    </div>
                </div>
                <div class="modal-footer">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <small class="text-muted">Alasan penolakan wajib diisi dan akan dilihat oleh mahasiswa</small>
                    </div>

                    <div class="alert alert-warning mb-0">
                        <i class="fas fa-exclamation-triangle mr-2"></i>
                        <strong>Perhatian:</strong> Setelah KRS ditolak, mahasiswa harus memperbaiki dan mengajukan kembali KRS-nya.
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">
...
@push('scripts')
    ...
    <script src="{{ asset('adminpage/own-js/dosen_page/akademik/perwalian/persetujuan_krs_dps.js') }}"></script>
@endpush
