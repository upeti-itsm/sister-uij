...
<main>
    <table>
        <thead>
        <tr>
            <th colspan="4" style="text-align: center">HONORARIUM KOREKSI DOSEN:
        ...
        <tr>
            ...
            <td style="width: 50%" colspan="2">
                <small>HR PEMBUATAN SOAL<br/>
                    (UTS Pagi: {{$data['rekap']->jml_soal_uts_pagi}} | UAS Pagi: {{$data['rekap']->jml_soal_uas_pagi}} | UTS Malam: {{$data['rekap']->jml_soal_uts_malam}} | UAS Malam: {{$data['rekap']->jml_soal_uas_malam}})</small>
            </td>
            <td style="width: 45%; text-align: right">
                <small>{{$data['rekap']->total_honor_kotor_pembuatan_soal}}</small>
            </td>
        </tr>
        <tr>
            ...
            <td style="width: 50%" colspan="2">
                <small>HR KOREKSI<br/>
                    (Jumlah Peserta Pagi: {{$data['rekap']->jml_peserta_pagi}} | Jumlah Peserta Malam: {{$data['rekap']->jml_peserta_malam}})</small>
            </td>
            <td style="width: 45%; text-align: right">
                <small>{{$data['rekap']->total_honor_kotor_honorarium_koreksi}}</small>
            </td>
        </tr>
        <tr>
            <td class="center" style="width: 5%"><small>2</small></td>
            <td style="width: 50%" colspan="2">
                <small>HR TATAP MUKA UJIAN MALAM<br/>
                    (Jumlah Matakuliah Malam: {{$data['rekap']->jml_matakuliah_malam}})</small>
            </td>
            <td style="width: 45%; text-align: right">
                <small>{{$data['rekap']->total_honor_kotor_honorarium_ujian_malam}}</small>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td style="width: 45%; text-align: right">
                <b>{{$data['rekap']->total_honorarium_koreksi}}</b>
            </td>
        </tr>
        </tbody>
    </table>
