    ...
    <div class="col-sm-8 header-title p-0">
        <div class="media">
            ...
            <div class="media-body">
                ...
                <small>Halaman ini digunakan untuk melihat Honorarium Koreksi untuk Dosen</small>
            </div>
        </div>
    </div>
@endsection
...
@push('scripts')
    ...
    <script
        src="{{asset('adminpage/own-js/dosen_page/keuangan/honorarium_koreksi/daftar.js')}}"></script>
@endpush
