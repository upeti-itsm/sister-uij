        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-sm-6 text-right">
                        ...
                        <div class="text-danger m-b-15">Perhitungan berdasarkan data absensi mengajar
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-nowrap">
                        ...
                        <tr>
                            <td>
                                <div>Honorarium Kelas Malam<br/>
                                    <small class="text-danger">{{$rekap->detail_honor_mengajar_dosen_malam}}</small>
                                </div>
                            </td>
                            <td style="text-align: right">{{$rekap->total_honor_kotor_mengajar_malam}}</td>
                        </tr>
                        <tr>
                            <td>
                                <div>Honorarium Kelas Pagi<br/>
                                    <small class="text-danger">{{$rekap->detail_honor_mengajar_dosen_pagi}}</small>
                                </div>
                            </td>
                            <td style="text-align: right">{{$rekap->total_honor_kotor_mengajar_pagi}}</td>
                        </tr>
                        <tr>
                            <td colspan="2">
                        ...
                        <tr>
                            ...
                            <td style="font-weight: bold; text-align: right">{{$rekap->total_honorarium_dosen_mengajar}}</td>
                        </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <div class="card-footer text-right">
                <a class="btn btn-danger-soft mr-2"
                   href="{{route('dosen_page.keuangan.honorarium.honorarium_mengajar.index')}}">Kembali</a>
                <a target="_blank"
                   href="{{route('dosen_page.keuangan.honorarium.honorarium_mengajar.slip_gaji', ['id_honorarium' => $id_honorarium])}}"
...
@push('scripts')
    ...
    <script src="{{asset('adminpage/own-js/dosen_page/keuangan/honorarium_mengajar/detail.js')}}"></script>
@endpush
