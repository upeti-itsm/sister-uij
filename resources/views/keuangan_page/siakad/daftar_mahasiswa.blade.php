                                        ...
                                        <div class="col-md-6">
                                            <select class="select2 form-control" id="angkatan">
                                                @foreach($angkatan AS $item)
                                                    <option value="{{trim($item->angkatan)}}">{{trim($item->angkatan)}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="col-md-6">
...
{{--                                                    <option value="{{trim($item->status_aktif)}}">{{trim($item->status_aktif)}}</option>--}}
{{--                                                @endforeach--}}
                                            </select>
                                        </div>
                                    </div>
...
@push('scripts')
    ...
    <script src="{{asset('adminpage/own-js/keuangan_page/siakad/mahasiswa.js')}}"></script>
@endpush
