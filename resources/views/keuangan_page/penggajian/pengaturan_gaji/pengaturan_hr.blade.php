...
@section('content-header')
    <nav aria-label="breadcrumb" class="col-sm-4 order-sm-last mb-3 mb-sm-0 p-0 ">
        <ol class="breadcrumb d-inline-flex font-weight-600 fs-13 bg-white mb-0 float-sm-right">
            ...
            <li class="breadcrumb-item active">Pengaturan HR Mengajar</li>
        </ol>
    </nav>
    <div class="col-sm-8 header-title p-0">
        <div class="media">
            ...
            <div class="media-body">
                ...
                <small>Halaman ini digunakan untuk melakukan pengaturan honor mengajar.</small>
            </div>
        </div>
    </div>
@endsection
        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="fs-17 font-weight-600 mb-0">Pengaturan HR Mengajar</h6>
                    </div>
                    <div class="text-right">
                        <div class="actions">
                            @include('partials.pengaturan_gaji_dropdown', ['title' => 'Pengaturan HR Mengajar'])
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <table class="table table-striped table-bordered table-hover" id="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-left align-middle">Nama Jabatan</th>
                        ...
                        <div class="row" style="padding: 0 0 0 0">
                            <div class="col-md-5">
                                <label class="font-weight-bold">
                                    Jabatan Fungsional <span id="keterangan" class="text-uppercase"></span>
                                </label>
                                <input type="text" class="form-control" placeholder="Masukkan Jabatan Fungsional"
                                    id="add_jabatan_fungsional">
                            </div>
                            <div class="col-md-7">
                                <label class="font-weight-bold">Nominal Mengajar</label>
...
@push('scripts')
    ...
    <script src="{{ asset('adminpage/own-js/keuangan_page/penggajian/pengaturan_gaji/pengaturan_hr.js') }}"></script>
    <script>
