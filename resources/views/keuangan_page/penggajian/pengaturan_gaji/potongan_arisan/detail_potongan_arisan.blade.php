    ...
    <div class="col-sm-8 header-title p-0">
        <div class="media">
            ...
            <div class="media-body">
                <h1 class="font-weight-bold">Detail Potongan Arisan</h1>
                <small>Halaman ini digunakan untuk mengelola potongan arisan masing-masing karyawan</small>
            </div>
        </div>
    </div>
@endsection
        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="fs-17 font-weight-600 mb-0">Detail Potongan Arisan</h6>
                    </div>
                    <div class="text-right">
                        <div class="actions">
                            <a href="{{route('keuangan.penggajian.pengaturan_gaji.potongan_arisan.index')}}"
                               class="action-item"><i class="ti-back-left mr-2"></i>Kembali</a>
                        </div>
                    </div>
                </div>
            </div>
...
@push('scripts')
    ...
    <script
        src="{{asset('adminpage/own-js/keuangan_page/penggajian/pengaturan_gaji/potongan_arisan/detail_potongan_arisan.js')}}"></script>
    <script>
