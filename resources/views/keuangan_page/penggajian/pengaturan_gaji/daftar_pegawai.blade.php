                        ...
                        <div class="row" id="main-display">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2 placeholder-multiple" id="jenis_karyawan"
                                        multiple="multiple">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="float-right">
                                        <button class="btn btn-success mr-2" title="Export Data Asuransi" id="btn_export"><i
                                                class="fas fa-file-excel"></i> Export Data Asuransi
                                        </button>
                                    </div>
                                </div>
                            </div>
