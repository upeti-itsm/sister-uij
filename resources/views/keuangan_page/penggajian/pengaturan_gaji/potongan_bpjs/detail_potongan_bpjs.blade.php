    ...
    <div class="col-sm-8 header-title p-0">
        <div class="media">
            ...
            <div class="media-body">
                <h1 class="font-weight-bold">Detail Pengaturan BPJS</h1>
                <small>Halaman ini digunakan untuk mengelola Pengaturan BPJS masing-masing karyawan</small>
            </div>
        </div>
    </div>
@endsection
        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="fs-17 font-weight-600 mb-0">Detail Pengaturan BPJS</h6>
                    </div>
                    <div class="text-right">
                        <div class="actions">
                            <a href="{{route('keuangan.penggajian.pengaturan_gaji.potongan_bpjs.index')}}" class="action-item"><i class="ti-back-left mr-2"></i>Kembali</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover" id="table">
                            ...
                            <tr>
                                ...
                                <th class="text-left align-middle">Tunjangan</th>
                                <th class="text-left align-middle">Pot. Kesehatan</th>
                                <th class="text-left align-middle">Pot. Ketenagakerjaan</th>
...
@push('scripts')
    ...
    <script src="{{asset('adminpage/own-js/keuangan_page/penggajian/pengaturan_gaji/potongan_bpjs/detail_potongan_bpjs.js')}}"></script>
    <script>
