    ...
    <div class="col-sm-8 header-title p-0">
        <div class="media">
            ...
            <div class="media-body">
                <h1 class="font-weight-bold">Pengaturan BPJS</h1>
                <small>Halama ini digunakan untuk melakukan konfigurasi/upload potongan dan tunjangan BPJS masing-masing
                    karyawan</small>
            </div>
        </div>
    </div>
        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="fs-17 font-weight-600 mb-0">Potongan dan Tunjangan BPJS</h6>
                    </div>
                    <div class="text-right">
                        <div class="actions">
                            @include('partials.pengaturan_gaji_dropdown', ['title' => 'Pengaturan BPJS'])
                        </div>
                    </div>
                </div>
            </div>
