    ...
    <div class="col-sm-8 header-title p-0">
        <div class="media">
            ...
            <div class="media-body">
                <h1 class="font-weight-bold">Potongan Pinjaman</h1>
                <small>Halama ini digunakan untuk melakukan konfigurasi/upload potongan pinjaman masing-masing
                    karyawan</small>
            </div>
        </div>
    </div>
            ...
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="text-right">
                        <div class="actions">
                            @include('partials.pengaturan_gaji_dropdown', ['title' => 'Potongan Pinjaman'])
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group" style="text-align: left">
                                ...
                                <small><a
                                        href="{{ asset('files/penggajian/template/potongan_koperasi_template.xlsx') }}">Download
