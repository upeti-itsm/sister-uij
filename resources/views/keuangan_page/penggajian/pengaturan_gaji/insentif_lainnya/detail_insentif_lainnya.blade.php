            ...
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="text-right">
                        <div class="actions">
                            <a href="{{route('keuangan.penggajian.pengaturan_gaji.insentif_lainnya.index')}}" class="action-item"><i class="ti-back-left mr-2"></i>Kembali</a>
                        </div>
                    </div>
                </div>
            </div>
...
@push('scripts')
    ...
    <script src="{{asset('adminpage/own-js/keuangan_page/penggajian/pengaturan_gaji/insentif_lainnya/detail_insentif_lainnya.js')}}"></script>
    <script>
