    ...
    <div class="col-sm-8 header-title p-0">
        <div class="media">
            ...
            <div class="media-body">
                <h1 class="font-weight-bold">Detail Insentif Lainnya</h1>
                <small>Halaman ini digunakan untuk mengelola insentif lainnya masing-masing karyawan</small>
            </div>
        </div>
    </div>
@endsection
        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="fs-17 font-weight-600 mb-0">Detail Insentif Lainnya</h6>
                    </div>
