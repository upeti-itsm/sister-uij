    ...
    <div class="col-sm-8 header-title p-0">
        <div class="media">
            ...
            <div class="media-body">
                <h1 class="font-weight-bold">Tunjangan Kinerja</h1>
                <small>Halama ini digunakan untuk melakukan konfigurasi Tunjangan Kinerja yang berlaku saat ini</small>
            </div>
        </div>
    </div>
@endsection
        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="fs-17 font-weight-600 mb-0">Tunjangan Kinerja</h6>
                    </div>
                    <div class="text-right">
                        <div class="actions">
                            @include('partials.pengaturan_gaji_dropdown', ['title' => 'Pengaturan Tunjangan Kinerja'])
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="col-md-7">
                                <div class="form-group">
                                    ...
                                    <div class="float-right">
                                        <button class="btn btn-primary" title="Tambah Data Tunjangan Kinerja"
                                                id="btn_add_data_kinerja"><i class="fas fa-plus-square"></i> Tambah Data
                                            Tunjangan Kinerja
                                        </button>
                                    </div>
                                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover" id="table">
                            ...
                            <tr>
                                ...
                                <th class="text-left align-middle">Nilai Kinerja</th>
...
@endsection
@section('modal')
    <div class="modal modal-primary fade" id="modal-insup-data-kinerja" tabindex="-1" role="dialog"
         aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                        ...
                        <div class="row" style="padding: 0 0 0 0">
                            ...
                            <div class="col-md-7">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control number" id="add_nominal_kinerja"
                                           placeholder="Masukkan Nominal Kinerja">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="add_keterangan"
                                  placeholder="Masukkan Keterangan Kinerja"></textarea>
                    </div>
                    <form id="add_form" style="display: none"
                        ...
                        <input type="hidden" name="nominal_kinerja" id="nominal_kinerja">
...
@push('scripts')
    ...
    <script
        src="{{asset('adminpage/own-js/keuangan_page/penggajian/pengaturan_gaji/daftar_tunjangan_kinerja.js')}}"></script>
@endpush
