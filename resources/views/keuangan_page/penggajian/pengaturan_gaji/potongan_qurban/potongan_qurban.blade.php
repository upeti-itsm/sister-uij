    ...
    <div class="col-sm-8 header-title p-0">
        <div class="media">
            ...
            <div class="media-body">
                <h1 class="font-weight-bold">Potongan Qurban</h1>
                <small>Halama ini digunakan untuk melakukan konfigurasi/upload potongan Qurban masing-masing
                    karyawan</small>
            </div>
        </div>
    </div>
        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="fs-17 font-weight-600 mb-0">Potongan Qurban</h6>
                    </div>
                    <div class="text-right">
                        <div class="actions">
                            <div class="dropdown action-item" data-toggle="dropdown" aria-expanded="true">
                                <a href="#" class="action-item">Potongan Qurban <i class="fas fa-bars fa-fw"></i></a>
                                <div class="dropdown-menu dropdown-menu-right" id="sub-menu">
                                    ...
                                    <a href="{{route('keuangan.penggajian.pengaturan_gaji.potongan_arisan.index')}}" class="dropdown-item">Potongan Arisan</a>
                            ...
                            <div class="col-md-7">
                                <div class="form-group">
                                    ...
                                    <div class="float-right">
                                        <button class="btn btn-success mr-2" title="Upload Potongan Qurban"
...
@endsection
@section('modal')
    <div class="modal modal-primary fade" id="modal-upload-potongan-qurban" tabindex="-1" role="dialog"
         aria-hidden="true">
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <label class="font-weight-bold">Periode Qurban</label>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Tanggal Mulai</label>
                                        <input type="text" placeholder="Tanggal Mulai"
                                               id="tgl_mulai_qurban" readonly class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Tanggal Selesai"
                                               id="tgl_selesai_qurban" readonly class="form-control">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group" style="text-align: left">
                                ...
                                <small><a href="{{asset('files/penggajian/template/potongan_qurban_template.xlsx')}}">Download
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-secondary disabled" id="btn-submit-file">Upload
                    </button>
                </div>
            </div>
        </div>
...
@push('scripts')
    ...
    <script src="{{asset('adminpage/own-js/keuangan_page/penggajian/pengaturan_gaji/potongan_qurban/potongan_qurban.js')}}"></script>
@endpush
