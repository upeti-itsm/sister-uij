                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            @if (array_key_exists('Pengelolaan Honorarium Koreksi', \Illuminate\Support\Facades\Session::get('modul')) ||
...
@push('scripts')
    ...
    <script src="{{ asset('adminpage/own-js/keuangan_page/penggajian/honorarium/honorarium_mengajar/daftar.js') }}">
    </script>
@endpush
