    ...
    <div class="col-sm-8 header-title p-0">
        <div class="media">
            ...
            <div class="media-body">
                <h1 class="font-weight-bold">Daftar Honorarium Pengawas</h1>
                <small>Halaman ini digunakan untuk mengelola Honorarium Pengawas untuk Dosen/Karyawan</small>
            </div>
        </div>
    </div>
@endsection
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h6 class="fs-17 font-weight-600 mb-0">Daftar Honorarium Pengawas</h6>
                            </div>
                            @if (array_key_exists('Pengelolaan Honorarium Pengawas', \Illuminate\Support\Facades\Session::get('modul')) ||
                                ...
                                <div class="text-right">
                                    <div class="actions">
                                        <div class="dropdown action-item" data-toggle="dropdown" aria-expanded="true">
                                            <a href="#" class="action-item">Honorarium Pengawas <i
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="float-right">
                                        <button class="btn btn-primary mr-2" id="btn_buat_honor"
                                            title="Buat Honor Pengawas Bulan Ini">
...
@push('scripts')
    ...
    <script src="{{ asset('adminpage/own-js/keuangan_page/penggajian/honorarium/honorarium_pengawas/daftar.js') }}">
    </script>
