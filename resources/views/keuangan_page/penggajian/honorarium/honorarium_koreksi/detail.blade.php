        ...
        <div class="card">
            <div class="card-header bg-info">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="text-white">
                        <h6 class="fs-17 font-weight-600 mb-0">Honorarium Koreksi Ujian</h6>
                        <small id="total_nominal_gaji">{{$rekap->total_honorarium_koreksi}}</small>
                    </div>
                </div>
            </div>
            <div class="card-body">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Honorarium Pembuatan Soal</label>
                                            <div class="input-group">
                                                ...
                                                <input readonly type="text"
                                                       ...
                                                       value="{{str_replace("Rp", "", $rekap->total_honor_kotor_pembuatan_soal)}}">
                                            </div>
                                            <small class="text-danger">(Jumlah Pembuatan Soal UTS Pagi ({{$rekap->jml_soal_uts_pagi}}) + Jumlah Pembuatan Soal UAS Pagi ({{$rekap->jml_soal_uas_pagi}}) + Jumlah Pembuatan Soal UTS Malam ({{$rekap->jml_soal_uts_malam}}) + Jumlah Pembuatan Soal UAS Malam ({{$rekap->jml_soal_uas_malam}})) * {{$rekap->honor_pembuatan_soal}}</small>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Honorarium Koreksi Ujian</label>
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <div class="input-group-text">Rp.</div>
                                                </div>
                                                <input readonly type="text"
                                                       ...
                                                       value="{{str_replace("Rp", "", $rekap->total_honor_kotor_honorarium_koreksi)}}">
                                            </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Honorarium TM Ujian Malam</label>
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <div class="input-group-text">Rp.</div>
                                                </div>
                                                <input readonly type="text"
                                                       class="form-control number" id="honor_kelas_pagi"
                                                       value="{{str_replace("Rp", "", $rekap->total_honor_kotor_honorarium_ujian_malam)}}">
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <small class="text-danger">2,5% dari total honor</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="card-footer">
                <div class="float-right">
                    ...
                    @if($rekap->is_repair)
                        <a href="{{route('keuangan.penggajian.honorarium.honorarium_koreksi.generate_ulang_honor', ['id_karyawan' => $karyawan->id_karyawan])}}" class="btn btn-success">Generate Ulang Honor</a>
                    @endif
                </div>
            </div>
        </div>
...
@push('scripts')
    ...
    <script src="{{asset('adminpage/own-js/keuangan_page/penggajian/honorarium/honorarium_koreksi/detail.js')}}"></script>
@endpush
