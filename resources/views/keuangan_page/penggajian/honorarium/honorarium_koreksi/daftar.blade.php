    ...
    <div class="col-sm-8 header-title p-0">
        <div class="media">
            ...
            <div class="media-body">
                <h1 class="font-weight-bold">Daftar Honorarium Koreksi</h1>
                <small>Halaman ini digunakan untuk mengelola Honorarium Koreksi untuk Dosen/Karyawan</small>
            </div>
        </div>
    </div>
@endsection
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h6 class="fs-17 font-weight-600 mb-0">Daftar Honorarium Koreksi</h6>
                            </div>
                            @if (array_key_exists('Pengelolaan Honorarium Mengajar', \Illuminate\Support\Facades\Session::get('modul')) ||
                                    array_key_exists('Pengelolaan Honorarium Mengajar', \Illuminate\Support\Facades\Session::get('modul')))
                                <div class="text-right">
                                    <div class="actions">
                                        <div class="dropdown action-item" data-toggle="dropdown" aria-expanded="true">
                                            <a href="#" class="action-item">Honorarium Koreksi <i
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right" id="sub-menu">
                                                <a href="{{ route('keuangan.penggajian.honorarium.honorarium_mengajar.index') }}"
                                                    class="dropdown-item">Honorarium Mengajar</a>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <select class="select2 form-control" id="filter_bulan">
                                                ...
                                                <option value="1" @if ($bulan == 1) selected @endif>
                                                    Januari</option>
                                                <option value="2" @if ($bulan == 2) selected @endif>
                                                    Februari</option>
                                                <option value="3" @if ($bulan == 3) selected @endif>
                                                    Maret</option>
                                                <option value="4" @if ($bulan == 4) selected @endif>
                                                    April</option>
                                                <option value="5" @if ($bulan == 5) selected @endif>Mei
                                                </option>
                                                <option value="6" @if ($bulan == 6) selected @endif>
                                                    Juni</option>
                                                <option value="7" @if ($bulan == 7) selected @endif>
                                                    Juli</option>
                                                <option value="8" @if ($bulan == 8) selected @endif>
                                                    Agustus</option>
                                                <option value="9" @if ($bulan == 9) selected @endif>
                                                    September</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="float-right">
                                        <button class="btn btn-primary mr-2" id="btn_buat_honor"
                                            title="Buat Honor Koreksi Bulan Ini">
                                        ...
                                        <button class="btn btn-success mr-2" title="Export ke Excel"
                                            id="btn_export_excel"><i class="fas fa-file-excel"></i>
                                        </button>
...
@push('scripts')
    ...
    <script src="{{ asset('adminpage/own-js/keuangan_page/penggajian/honorarium/honorarium_koreksi/daftar.js') }}"></script>
