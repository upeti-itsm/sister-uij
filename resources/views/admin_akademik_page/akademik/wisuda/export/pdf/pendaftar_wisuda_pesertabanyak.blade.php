    ...
    <table>
        ...
        @foreach($pendaftar as $item)
            @if($no == 1)
                ...
                <tr>
                    <td class="center" style="width: 25%; vertical-align: top">
                        <b>{{$item->nomor_urut}}</b><br/>
                        <img data-nomor="{{$no++}}" data-nama_prodi="{{$nama_prodi = $item->nama_prodi}}"
                             src="http://siakad.stie-mandala.ac.id/_report/photo_m/{{$item->nim}}.jpg"
                             height="200"><br/>
                        <b>{{$item->nomor_pendaftaran_wisuda}}</b>
                    </td>
                    <td style="width: 75%;">
                        <div style=" width: 100%">
                            <div style="width: 30%; display: inline-block; vertical-align: top; margin-bottom: 5px"><b>Nama
                                    Lengkap</b></div>
                        ...
                        <div style=" width: 100%">
                            <div style="width: 30%; display: inline-block; vertical-align: top; margin-bottom: 5px"><b>NIM</b>
                            </div>
                            <div style="width: 3%; display: inline-block; vertical-align: top; margin-bottom: 5px">:
                            </div>
                            <div
                        ...
                        <div style=" width: 100%">
                            <div style="width: 30%; display: inline-block; vertical-align: top; margin-bottom: 5px"><b>Tempat
                                    / Tanggal Lahir</b></div>
                            <div style="width: 3%; display: inline-block; vertical-align: top; margin-bottom: 5px">:
                            </div>
                            <div
                        ...
                        <div style=" width: 100%">
                            <div style="width: 30%; display: inline-block; vertical-align: top; margin-bottom: 5px"><b>Alamat</b>
                            </div>
                            <div style="width: 3%; display: inline-block; vertical-align: top; margin-bottom: 5px">:
                            </div>
                            <div
                        ...
                        <div style=" width: 100%">
                            <div style="width: 30%; display: inline-block; vertical-align: top; margin-bottom: 5px"><b>Nomor
                                    Hand Phone</b></div>
                            <div style="width: 3%; display: inline-block; vertical-align: top; margin-bottom: 5px">:
                            </div>
                            <div
                        ...
                        <div style=" width: 100%">
                            <div style="width: 30%; display: inline-block; vertical-align: top; margin-bottom: 5px"><b>Email</b>
                            </div>
                            <div style="width: 3%; display: inline-block; vertical-align: top; margin-bottom: 5px">:
                            </div>
                            <div
                        ...
                        <div style=" width: 100%">
                            <div style="width: 30%; display: inline-block; vertical-align: top; margin-bottom: 5px"><b>Dosen
                                    Pembimbing Utama</b></div>
                            <div style="width: 3%; display: inline-block; vertical-align: top; margin-bottom: 5px">:
                            </div>
                            <div
                                style="width: 65%; display: inline-block; vertical-align: top; margin-bottom: 5px">{{$item->dpu}}
                            </div>
                        </div>
                        <div style=" width: 100%">
                            <div style="width: 30%; display: inline-block; vertical-align: top; margin-bottom: 5px"><b>Dosen
                            ...
                            <div
                                style="width: 65%; display: inline-block; vertical-align: top; margin-bottom: 5px">{{$item->dpa}}
                            </div>
                        </div>
                        <div style=" width: 100%">
                            <div style="width: 30%; display: inline-block; vertical-align: top; margin-bottom: 5px"><b>IP
                                    Kumulatif</b></div>
                            <div style="width: 3%; display: inline-block; vertical-align: top; margin-bottom: 5px">:
                            </div>
                            <div
                        ...
                        <div style=" width: 100%">
                            <div style="width: 30%; display: inline-block; vertical-align: top; margin-bottom: 5px"><b>Judul
                                    Tugas Akhir</b></div>
                            <div style="width: 3%; display: inline-block; vertical-align: top; margin-bottom: 5px">:
                            </div>
                            <div
                ...
                @if($nama_prodi == $item->nama_prodi)
                    <tr>
                        <td class="center" style="width: 25%; vertical-align: top">
                            <b>{{$item->nomor_urut}}</b><br/>
                            <img data-nomor="{{$no++}}" data-nama_prodi="{{$nama_prodi = $item->nama_prodi}}"
                                 src="http://siakad.stie-mandala.ac.id/_report/photo_m/{{$item->nim}}.jpg" height="200"><br/>
                            <b>{{$item->nomor_pendaftaran_wisuda}}</b>
                        </td>
                        <td style="width: 75%;">
                            <div style=" width: 100%">
