    ...
    <div class="col-sm-8 header-title p-0">
        <div class="media">
            ...
            <div class="media-body">
                <h1 class="font-weight-bold">Jadwal Kuliah</h1>
                <small>Halaman ini digunakan untuk mengatur/mengelola jadwal perkulihan di lingkungan Universita Islam
                    Jember</small>
            </div>
        </div>
    </div>
        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="fs-17 font-weight-600 mb-0">Jadwal Kuliah</h6>
                    </div>
                </div>
            </div>
            <div class="card-body">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group mb-3">
                                            <input type="text" class="form-control"
                                                   placeholder="Masukkan Nama Matakuliah" id="cari-log">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover" id="log-table">
                                        ...
                                        <tr>
                                            ...
                                            <th style="width: 30%">Nama Matakuliah (Kelas)</th>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="float-right">
                                        <button class="btn btn-success mr-2" title="Upload Jadwal Kuliah"
                                                id="btn_upload_jadwal"><i class="fas fa-file-excel"></i> Upload
                                            Jadwal
                                        </button>
                                    </div>
                                </div>
...
@endsection
@section('modal')
    <div class="modal modal-primary fade" id="modal-upload-jadwal" tabindex="-1" role="dialog"
         aria-hidden="true">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group" style="text-align: left">
                                ...
                                <small><a
                                        href="{{ asset('files/penggajian/template/jadwal.xlsx') }}">Download
                                        Template Jadwal</a></small>
                            </div>
                        </div>
                    </div>
                </div>
...
@push('scripts')
    ...
    <script
        src="{{ asset('adminpage/own-js/admin_akademik/akademik/matakuliah/jadwal_kuliah.js') }}">
    </script>
    <script>
