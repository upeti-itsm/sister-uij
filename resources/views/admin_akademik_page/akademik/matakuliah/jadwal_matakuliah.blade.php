...
@section('body-content')
    <input type="hidden" id="hak_akses" value="{{\Illuminate\Support\Facades\Session::get('modul')['Sinkronisasi Jadwal Kuliah dengan Siakad']}}">
    <div class="col-md-12">
        <div class="card">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <select class="select2 form-control" id="status_pengajar">
                                                ...
                                                <option value="0" @if($filter == 0) selected @endif>Belum Ditentukan</option>
                                                <option value="1" @if($filter == 1) selected @endif>Individu</option>
                                                <option value="2" @if($filter == 2) selected @endif>TIM</option>
                                                <option value="3"  @if($filter == 3) selected @endif>Koordinator</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
