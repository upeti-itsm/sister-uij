...
@section('content-header')
    <nav aria-label="breadcrumb" class="col-sm-4 order-sm-last mb-3 mb-sm-0 p-0 ">
        <ol class="breadcrumb d-inline-flex font-weight-600 fs-13 bg-white mb-0 float-sm-right">
            ...
            <li class="breadcrumb-item active">Mahasiswa LP3I</li>
        </ol>
    </nav>
    <div class="col-sm-8 header-title p-0">
        <div class="media">
            ...
            <div class="media-body">
                <h1 class="font-weight-bold">Mahasiswa LP3I</h1>
                <small>Halaman ini digunakan untuk pengelolaan data mahasiswa LP3I</small>
            </div>
        </div>
    </div>
@endsection
@section('body-content')
    <input type="hidden" id="hak_akses" value="{{\Illuminate\Support\Facades\Session::get('modul')['Pengelolaan Mahasiswa LP3I Banyuwangi']}}">
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="fs-17 font-weight-600 mb-0">Daftar Data Mahasiswa</h6>
                    </div>
                </div>
            </div>
            <div class="card-body">
                            ...
                            <div class="col-md-7">
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <input type="checkbox" id="is_lp3i" checked>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover" id="table">
                            ...
                            <tr>
                                ...
                                <th class="text-center">Identitas Mahasiswa</th>
                                <th class="text-center">Identitas Prodi</th>
...
@push('scripts')
    ...
    <script src="{{asset('adminpage/own-js/admin_akademik/akademik/mahasiswa/daftar_mahasiswa_lpppi.js')}}"></script>
@endpush
