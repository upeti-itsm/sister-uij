...
@section('content-header')
    <nav aria-label="breadcrumb" class="col-sm-4 order-sm-last mb-3 mb-sm-0 p-0 ">
        <ol class="breadcrumb d-inline-flex font-weight-600 fs-13 bg-white mb-0 float-sm-right">
            ...
            <li class="breadcrumb-item active">Student Body</li>
        </ol>
    </nav>
    <div class="col-sm-8 header-title p-0">
        <div class="media">
            ...
            <div class="media-body">
                <h1 class="font-weight-bold">Student Body</h1>
                <small>Halaman ini digunakan untuk menampilkan student body dari ITS Mandala dalam 5 Tahun</small>
            </div>
        </div>
    </div>
@endsection
        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="fs-17 font-weight-600 mb-0">Daftar Student Body</h6>
                    </div>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover" id="table">
                            ...
                            <tr>
                                ...
                                <th class="text-center" rowspan="2">Daya Tampung</th>
                                <th class="text-center" colspan="2">Jumlah Calon Mahasiswa</th>
                                <th class="text-center" colspan="2">Jumlah Mahasiswa Baru</th>
                                <th class="text-center" colspan="2">Jumlah Mahasiswa Aktif</th>
                            </tr>
                            <tr>
...
@push('scripts')
    ...
    <script src="{{asset('adminpage/own-js/admin_akademik/akademik/mahasiswa/student_body.js')}}"></script>
@endpush
