...
@section('content-header')
    <nav aria-label="breadcrumb" class="col-sm-4 order-sm-last mb-3 mb-sm-0 p-0 ">
        <ol class="breadcrumb d-inline-flex font-weight-600 fs-13 bg-white mb-0 float-sm-right">
            ...
            <li class="breadcrumb-item active">Jenis Pelaksanaan Kuliah</li>
        </ol>
    </nav>
    <div class="col-sm-8 header-title p-0">
        <div class="media">
            ...
            <div class="media-body">
                <h1 class="font-weight-bold">Jenis Pelaksanaan Kuliah</h1>
                <small>Halaman ini digunakan untuk mengelola data Jenis Pelaksanaan Kuliah yang ada</small>
            </div>
        </div>
    </div>
@endsection
        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="fs-17 font-weight-600 mb-0">Daftar Jenis Pelaksanaan Kuliah</h6>
                    </div>
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-12 collapse" id="form-collapse">
                        <input type="hidden" value="0" id="id_jenis_pelaksanaan_kuliah">
                        <div class="form-group">
