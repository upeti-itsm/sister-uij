    ...
    <div class="col-sm-8 header-title p-0">
        <div class="media">
            ...
            <div class="media-body">
                ...
                <small>Halaman ini digunakan untuk mengelola data Mahasiswa (Syncronisasi dengan
                            ...
                            <div class="text-right">
                                <div class="actions">
                                    <button class="btn btn-info-soft btn-sync-ulang" id="btn-sync-ulang"
                                            ...
                                            class="fas fa-cloud-download-alt"></i> Update Data dari Feeder
                                    </button>
                                    <button class="btn btn-danger-soft btn-sync-insert" id="btn-sync-ulang"
                                            title="Update Data ke Feeder"><i
                                            class="fas fa-cloud-upload-alt"></i> Update Data ke Feeder
                                    </button>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row" id="row-list-data">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <input type="text" class="form-control" placeholder="Cari NIM/Nama Mahasiswa"
                                           id="cari-data">
                                </div>
                                <div class="col-md-4">
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <select class="form-control select2" name="kd_prodi" id="prodi">
                                ...
                                <div class="col-md-4">
                                    <select class="form-control select2" name="semester" id="semester">
                                        <option value="0">-- Semester Masuk --</option>
...
@push('scripts')
    ...
    <script src="{{asset('adminpage/own-js/admin_akademik/sinkronisasi_data/mahasiswa.js')}}"></script>
@endpush
