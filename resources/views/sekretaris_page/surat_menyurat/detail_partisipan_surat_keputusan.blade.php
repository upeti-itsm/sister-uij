...
@section('content-header')
    <nav aria-label="breadcrumb" class="col-sm-4 order-sm-last mb-3 mb-sm-0 p-0 ">
        <ol class="breadcrumb d-inline-flex font-weight-600 fs-13 bg-white mb-0 float-sm-right">
            <li class="breadcrumb-item">Surat Keputusan</li>
    ...
    <div class="col-sm-8 header-title p-0">
        <div class="media">
            ...
            <div class="media-body">
                <h1 class="font-weight-bold">Detail Surat Keputusan</h1>
        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <input type="hidden" id="id_sk" value="{{$id_surat}}">
                        <h6 class="fs-17 font-weight-600 mb-0">Daftar Pengakses SK</h6>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" readonly value="{{$surat->nomor_sk}}" class="form-control">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Tanggal SK</label>
                            <input type="text" readonly value="{{$surat->tanggal_sk_}}" class="form-control">
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                            <label>Nama SK</label>
                            <input type="text" readonly value="{{$surat->nama_sk}}" class="form-control">
                        </div>
                        <hr/>
                    </div>
                            ...
                            <div class="col-md-7">
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <a href="{{route('sekretaris.surat_menyurat.surat_keputusan.index')}}" class="btn btn-block btn-danger" id="btn-kembali"><i
...
@push('scripts')
    ...
    <script
        src="{{asset('adminpage/own-js/sekretaris_page/surat_menyurat/detail_partisipan_surat_keputusan.js')}}"></script>
@endpush
