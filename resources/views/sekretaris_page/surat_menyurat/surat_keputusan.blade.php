                    ...
                    <div class="col-md-12 collapse" id="form-collapse-sk">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <form action="{{ route('sekretaris.surat_menyurat.surat_keputusan.insert_sk') }}"
                                            enctype="multipart/form-data" method="POST" id="form-collapse-sk-form_submit">
                                            @csrf
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="select2 form-control"
                                                            id="pilihan-akses-surat-keputusan" name="pilihan_akses">
                                                        ...
                                                        <div class="mt-2" id="akses-display">
                                                            <select class="form-control select2 placeholder-multiple"
                                                                id="penerima_surat" name="akses[]" multiple="multiple">
                        ...
                        <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-md-8">
                                                    <input type="text" class="form-control" placeholder="Cari Nama SK"
                                                        id="cari-data">
                                                </div>
                                                <div class="col-md-4">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-md-5">
                                                    <select class="select2 form-control" id="filtering-tahun-sk">
                                                        @if (!empty($tahun_sk))
                                                            @foreach ($tahun_sk as $item)
                                                                <option value="{{ $item->tahun_sk }}">{{ $item->tahun_sk }}
                                                                </option>
                                                            @endforeach
                                                        @else
                                                ...
                                                <div class="col-md-7">
                                                    <button class="btn btn-block btn-danger" id="btn-tambah-sk"><i
                            ...
                            <div class="col-md-12 mt-3">
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover" id="table-sk">
                                        <thead>
                                            <tr>
                                                <th>Nomor</th>
                                                <th>Nomor SK</th>
