    ...
    <div class="col-sm-8 header-title p-0">
        <div class="media">
            ...
            <div class="media-body">
                <h1 class="font-weight-bold">Detail Surat Keluar</h1>
        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <input type="hidden" id="id_surat_keluar" value="{{$id_surat}}">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" readonly value="{{$surat->nomor_surat_keluar}}" class="form-control">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Tanggal Surat</label>
                            <input type="text" readonly value="{{$surat->tanggal_surat_keluar_}}" class="form-control">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>Kode</label>
                            <input type="text" readonly value="{{$surat->kode_surat_keluar}}" class="form-control">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Perihal</label>
                            <input type="text" readonly value="{{$surat->perihal_surat_keluar}}" class="form-control">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Penerima</label>
                            <input type="text" readonly value="{{$surat->penerima_surat_keluar}}" class="form-control">
                        </div>
                    </div>
                    <div class="col-md-12">
                        <hr/>
                            ...
                            <div class="col-md-7">
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <a href="{{route('sekretaris.surat_menyurat.surat_keluar_masuk.index')}}" class="btn btn-block btn-danger" id="btn-kembali"><i
...
@push('scripts')
    ...
    <script
        src="{{asset('adminpage/own-js/sekretaris_page/surat_menyurat/detail_partisipan_surat_keluar.js')}}"></script>
@endpush
