...
@section('content-header')
    <nav aria-label="breadcrumb" class="col-sm-4 order-sm-last mb-3 mb-sm-0 p-0 ">
        <ol class="breadcrumb d-inline-flex font-weight-600 fs-13 bg-white mb-0 float-sm-right">
            ...
            <li class="breadcrumb-item active">Daftar Arsip Surat</li>
        </ol>
    </nav>
    <div class="col-sm-8 header-title p-0">
        <div class="media">
            ...
            <div class="media-body">
                <h1 class="font-weight-bold">Daftar Arsip Surat</h1>
                <small>Halaman ini digunakan untuk melihat Arsip surat menyurat yang ditujukan kepada masing-masing dosen/karyawan</small>
            </div>
        </div>
    </div>
@endsection
        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="fs-17 font-weight-600 mb-0">Daftar Arsip Surat</h6>
                    </div>
                </div>
            </div>
            <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <select class="select2 form-control" id="tahun_surat">
...
@push('scripts')
    ...
    <script src="{{asset('adminpage/own-js/karyawan_page/surat_menyurat/surat.js')}}"></script>
@endpush
