    ...
    <div class="col-sm-8 header-title p-0">
        <div class="media">
            ...
            <div class="media-body">
                ...
                <small>Halaman ini digunakan untuk melihat Gaji Bulananan masing-masing Dosen/Karyawan</small>
            </div>
        </div>
    </div>
@endsection
...
@push('scripts')
    ...
    <script src="{{asset('adminpage/own-js/karyawan_page/penggajian/daftar_gaji_bulanan.js')}}"></script>
@endpush
