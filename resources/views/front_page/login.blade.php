...
<body class="bg-white"
    style="background-image: url('{{ asset('image/bg_login.webp') }}'); background-repeat: no-repeat; background-size: cover">
    <div class="d-flex align-items-center justify-content-center text-center h-100vh">
        <div class="form-wrapper m-auto">
            <div class="form-container my-4">
                <div class="register-logo text-center mb-4">
                    <img src="{{ asset('image/Logos.png') }}" class="img-fluid" style="max-width: 100%" alt="">
                </div>
                <div class="panel">
                    ...
                    <form class="register-form" action="{{ route('login.auth') }}" method="post">
                        ...
                        <div class="form-group text-left">
                            ...
                            @if ($errors->has('username'))
                                <div class="invalid-feedback text-left" id="invalid-username">
                        ...
                        <div class="form-group text-left">
                            ...
                            @if ($errors->has('password'))
                                <div class="invalid-feedback text-left" id="invalid-password">
                                    {{ $errors->first('password') }}</div>
                            @endif
                        </div>
                        <button type="submit" class="btn btn-block btn-success btn-block">Masuk</button>
                        <a href="{{ route('login.lupa_password') }}" class="btn btn-block btn-danger">Lupa Password
                            ?</a>
                    </form>
                </div>
            </div>
