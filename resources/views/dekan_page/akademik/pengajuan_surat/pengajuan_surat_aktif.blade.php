...
@section('content-header')
    <nav aria-label="breadcrumb" class="col-sm-4 order-sm-last mb-3 mb-sm-0 p-0">
        <ol class="breadcrumb d-inline-flex font-weight-600 fs-13 bg-white mb-0 float-sm-right">
            ...
            <li class="breadcrumb-item active">Pengesahan Surat</li>
        </ol>
    </nav>
    <div class="col-sm-8 header-title p-0">
        <div class="media">
            ...
            <div class="media-body">
                <h1 class="font-weight-bold">Pengesahan Surat Aktif (Dekan)</h1>
                <small>Pengesahan akhir untuk surat aktif mahasiswa.</small>
            </div>
        </div>
    </div>
@endsection
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalDetailDekanLabel">Detail Pengajuan Surat Aktif</h5>
...
@push('scripts')
    ...
    <script src="{{ asset('adminpage/own-js/dekan_page/akademik/pengajuan_surat/pengajuan_surat_aktif.js') }}"></script>
@endpush
