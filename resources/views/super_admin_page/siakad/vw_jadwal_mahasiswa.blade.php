    ...
    <div class="col-sm-8 header-title p-0">
        <div class="media">
            ...
            <div class="media-body">
                <h1 class="font-weight-bold">Jadwal Mahasiswa</h1>
                <small>Halaman ini digunakan monitoring jadwal/KRS Mahasiswa di siakad yang berkaitan dengan moodle</small>
            </div>
        </div>
    </div>
@endsection
        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="fs-17 font-weight-600 mb-0">Jadwal Mahasiswa</h6>
                    </div>
                </div>
            </div>
            <div class="card-body">
                                        ...
                                        <div class="col-md-9">
                                            <select class="select2 form-control" id="tahun_akademik">
                                                @foreach($tahun_akademik AS $item)
                                                    <option value="{{$item->kdakademik}}">{{$item->akademik}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="col-md-3">
...
@push('scripts')
    ...
    <script src="{{asset('adminpage/own-js/super_admin/siakad/vw_jadwal_mahasiswa.js')}}"></script>
@endpush
