    ...
    <div class="col-sm-8 header-title p-0">
        <div class="media">
            ...
            <div class="media-body">
                ...
                <small>Halaman ini digunakan untuk minitoring data dosen pada database siakad</small>
            </div>
        </div>
    </div>
@endsection
...
@push('scripts')
    ...
    <script src="{{asset('adminpage/own-js/super_admin/siakad/dosen.js')}}"></script>
@endpush
