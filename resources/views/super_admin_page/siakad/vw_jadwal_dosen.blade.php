    ...
    <div class="col-sm-8 header-title p-0">
        <div class="media">
            ...
            <div class="media-body">
                ...
                <small>Halaman ini digunakan monitoring jadwal dosen di siakad yang berkaitan dengan moodle</small>
            </div>
        </div>
    </div>
@endsection
        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="fs-17 font-weight-600 mb-0">Jadwal Dosen</h6>
                    </div>
                </div>
            </div>
            <div class="card-body">
...
@push('scripts')
    ...
    <script src="{{asset('adminpage/own-js/super_admin/siakad/vw_jadwal_dosen.js')}}"></script>
@endpush
