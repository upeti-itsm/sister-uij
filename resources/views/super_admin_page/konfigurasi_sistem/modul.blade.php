    ...
    <div class="col-sm-8 header-title p-0">
        <div class="media">
            ...
            <div class="media-body">
                <h1 class="font-weight-bold">Modul</h1>
                <small>Halaman ini digunakan untuk mengelola data Modul pada setiap aplikasi yang ada</small>
            </div>
        </div>
    </div>
@endsection
        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="fs-17 font-weight-600 mb-0">Daftar Modul</h6>
                    </div>
                    ...
                    <div class="col-md-12 collapse" id="form-collapse">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="keterangan"
                                      placeholder="Masukkan Keterangan Modul"></textarea>
                        </div>
                        <div class="form-group">
                            <div class="float-right">
                                <a class="btn btn-danger text-white  mr-2" id="btn-cancel"><i
                                        class="fas fa-backward mr-2"></i>Batal</a>
                                <a class="btn btn-primary text-white" id="btn-save-modul"><span
...
@push('scripts')
    ...
    <script src="{{asset('adminpage/own-js/super_admin/konfigurasi_sistem/modul.js')}}"></script>
@endpush
