...
@section('content-header')
    <nav aria-label="breadcrumb" class="col-sm-4 order-sm-last mb-3 mb-sm-0 p-0 ">
        <ol class="breadcrumb d-inline-flex font-weight-600 fs-13 bg-white mb-0 float-sm-right">
            ...
            <li class="breadcrumb-item active">Kewenangan Peran</li>
        </ol>
    </nav>
    <div class="col-sm-8 header-title p-0">
        <div class="media">
            ...
            <div class="media-body">
                <h1 class="font-weight-bold">Kewenangan Peran</h1>
                <small>Halaman ini digunakan untuk mengelola data Kewenangan Peran pada setiap aplikasi yang ada</small>
            </div>
        </div>
    </div>
@endsection
...
@push('scripts')
    ...
    <script src="{{asset('adminpage/own-js/super_admin/konfigurasi_sistem/kewenangan_peran.js')}}"></script>
@endpush
