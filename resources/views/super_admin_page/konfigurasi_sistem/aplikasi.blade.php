    ...
    <div class="col-sm-8 header-title p-0">
        <div class="media">
            ...
            <div class="media-body">
                <h1 class="font-weight-bold">Aplikasi</h1>
                <small>Halaman ini digunakan untuk mengelola data Aplikasi yang dikelola oleh mandala</small>
            </div>
        </div>
    </div>
@endsection
        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="fs-17 font-weight-600 mb-0">Daftar Aplikasi</h6>
                    </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6 collapse show" id="filter-collapse">
                        <div class="form-group">
                            <label class="font-weight-bold">Pencarian</label>
                            <div class="row">
                                <div class="col-md-8">
                                    <input type="text" class="form-control" placeholder="Cari Nama Aplikasi"
                                           id="cari-data">
                                </div>
                                <div class="col-md-4">
                    ...
                    <div class="col-md-12 collapse" id="form-collapse">
                        <input type="hidden" id="id_aplikasi">
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="float-right">
                                ...
                                <a class="btn btn-primary text-white" id="btn-save-aplikasi"><span
...
@push('scripts')
    ...
    <script src="{{asset('adminpage/own-js/super_admin/konfigurasi_sistem/aplikasi.js')}}"></script>
@endpush
