    ...
    <div class="col-sm-8 header-title p-0">
        <div class="media">
            ...
            <div class="media-body">
                <h1 class="font-weight-bold">Suspended Mahasiswa</h1>
                <small>Halaman ini digunakan untuk mengelola suspended mahasiswa berdasarkan tanggungan keuangan di
                    siakad</small>
            </div>
        </div>
    </div>
        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="fs-17 font-weight-600 mb-0">Daftar Suspended Mahasiswa</h6>
                    </div>
                    <div class="text-right">
                        <div class="actions">
                            <button class="btn btn-danger-soft btn-sync-ulang mr-2" id="btn-suspend"
                                    title="Suspend Mahasiswa"><i
                                    class="fas fa-user-lock"></i> Suspend Mahasiswa
                            </button>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 collapse show" id="filter-collapse">
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                <div class="form-group">
                                    <label class="font-weight-bold">Filtering Angkatan</label>
                                    <div class="row">
                                        <div class="col-md-12">
...
@endsection
@section('modal')
    <div class="modal modal-primary fade" id="modal-suspend-mahasiswa" tabindex="-1" role="dialog"
         aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title font-weight-600">Konfirmasi Suspend Mahasiswa</h5>
                    <button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <p>Jika dilakukan proses suspend, maka sistem akan membaca tanggungan mahasiswa di siakad dan
                        melakukan suspend kepada akun-akun yang memiliki tanggungan lebih dari sama dengan (>=) batas
                        tanggungan<br/>
                        <b class="text-danger">* Tanggungan sebesar batas yang di inputkan akan ikut tersuspend</b>
                    </p>
                    <div class="form-group">
                        <input type="number" id="batas_tanggungan" placeholder="Masukkan Batas Minimal Tanggungan" class="form-control">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <select class="select2 form-control" id="jenis_kelas">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-success" id="modal-btn-suspend"><i
                            class="fas fa-sync mr-2"></i>Suspend Mahasiswa
                    </button>
                </div>
            </div>
        </div>
...
@push('scripts')
    ...
    <script src="{{asset('adminpage/own-js/super_admin/moodle/suspended_mahasiswa.js')}}"></script>
@endpush
