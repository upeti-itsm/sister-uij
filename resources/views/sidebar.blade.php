...
//                          array_key_exists('Surat Keluar Masuk', $modul) ||
                    ...
                    @endif
                    @if (
array_key_exists('Pengelolaan Gaji Bulanan', $modul) ||
array_key_exists('Pengaturan Gaji', $modul) ||
array_key_exists('Melihat Gaji Bulanan', $modul) ||
array_key_exists('Melihat Honorarium Mengajar', $modul) ||
array_key_exists('Melihat Honorarium Koreksi', $modul)
)
                        <li class="{{ in_array($menu, [
        'Pengelolaan Gaji Bulanan', 'Pengaturan Gaji - Daftar Pegawai', 'Pengaturan Gaji - Gaji Umum',
        ...
        'Melihat Honorarium Mengajar', 'Melihat Honorarium Koreksi', 'Pengaturan Gaji - Insentif Lainnya', 'Pengaturan Gaji - Daftar Tunjangan Fungsional'
                            ...
                            <ul class="nav-second-level">
                                ...
                                @if (array_key_exists('Melihat Honorarium Mengajar', $modul) || array_key_exists('Melihat Honorarium Koreksi', $modul))
                                    <li class="{{ in_array($menu, ['Melihat Honorarium Mengajar', 'Melihat Honorarium Koreksi']) ? 'mm-active' : '' }}">
                                        ...
                                        <ul class="nav-third-level mm-collapse">
                                            @if (array_key_exists('Melihat Honorarium Mengajar', $modul))
                                                <li class="{{ $menu == 'Melihat Honorarium Mengajar' ? 'mm-active' : '' }}">
                                            ...
                                            @if (array_key_exists('Melihat Honorarium Koreksi', $modul))
                                                <li class="{{ $menu == 'Melihat Honorarium Koreksi' ? 'mm-active' : '' }}">
                                ...
                                @if (array_key_exists('Melihat Gaji Bulanan', $modul))
                                    <li class="{{ $menu == 'Melihat Gaji Bulanan' ? 'mm-active' : '' }}">
                                        <a href="{{ route('karyawan.penggajian.gaji_bulanan.index') }}">Gaji Bulanan</a>
                                    </li>
                                @endif
                                ...
                                @if (
                                    array_key_exists('Pengelolaan Honorarium Mengajar', $modul) ||
                                    array_key_exists('Pengelolaan Honorarium Koreksi', $modul) ||
                                    array_key_exists('Pengelolaan Honorarium Pengawas', $modul)
                                )
                                    <li class="{{ in_array($menu, ['Pengelolaan Honorarium Mengajar', 'Pengelolaan Honorarium Koreksi', 'Pengelolaan Honorarium Pengawas']) ? 'mm-active' : '' }}">
                                        <a href="@if (array_key_exists('Pengelolaan Honorarium Mengajar', $modul)) {{ route('keuangan.penggajian.honorarium.honorarium_mengajar.index') }}
                            ...
                            <ul class="nav-second-level">
                                ...
                                @if (array_key_exists('Ploting Matakuliah', $modul))
                                    <li @if ($menu == 'Ploting Matakuliah') class="mm-active" @endif>
                                        <a href="{{ route('plotting_perkuliahan.index') }}">Ploting Matakuliah</a>
                                    </li>
                                @endif
                            </ul>
                        </li>
