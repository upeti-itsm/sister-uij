                        ...
                        @if (array_key_exists('Pengelolaan Gaji Bulanan', $modul) ||
                            ...
                            <li @if (
                                $menu == 'Pengelolaan Gaji Bulanan' ||
                                    ...
                                    $menu == 'Melihat Honorarium Koreksi') class="mm-active" @endif>
                                <a class="has-arrow material-ripple" href="#">
                                    <i class="typcn typcn-th-list mr-2"></i>
                                    Penggajian
                                </a>
                                <ul class="nav-second-level">
                                    ...
                                    @if (array_key_exists('Pengelolaan Honorarium Mengajar', $modul) ||
                                        ...
                                        <li @if (
                                            $menu == 'Pengelolaan Honorarium Mengajar' ||
                                                $menu == 'Pengelolaan Honorarium Koreksi' ||
                                                $menu == 'Pengelolaan Honorarium Pengawas') class="mm-active" @endif>
                                            <a
                                                @if (array_key_exists('Pengelolaan Honorarium Mengajar', $modul)) href="{{ route('keuangan.penggajian.honorarium.honorarium_mengajar.index') }}"
                                    ...
                                    @if (array_key_exists('Pengaturan Gaji', $modul))
                                        <li @if (
                                            $menu == 'Pengaturan Gaji - Daftar Pegawai' ||
                                                $menu == 'Pengaturan Gaji - Gaji Umum' ||
                                                $menu == 'Pengaturan Gaji - Potongan Koperasi' ||
                                                $menu == 'Pengaturan Gaji - Potongan BPJS') class="mm-active" @endif>
                                            <a
