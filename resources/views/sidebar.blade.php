    ...
    <div class="wrapper">
        ...
        <nav class="sidebar sidebar-bunker">
            <div class="sidebar-header">
                ...
                <a href="{{ route('dashboard.dashboard') }}" class="logo"><img src="{{ asset('image/Logos.png') }}"
                        alt=""></a>
            </div><!--/.sidebar header-->
            <div class="profile-element d-flex align-items-center flex-shrink-0 bg-dark">
                ...
                <div class="profile-text">
                    <small
                        class="m-0 text-white text-uppercase">{{ \Illuminate\Support\Facades\Session::get('user')->nama_lengkap }}</small><br />
                    @if (isset(\Illuminate\Support\Facades\Session::get('user')->id_mhs))
                        <small class="d-block text-white-50">NIM:
                            {{ \Illuminate\Support\Facades\Session::get('user')->nim }}</small>
                    @endif
                ...
                <nav class="sidebar-nav">
                    ...
                    @endif --}}
                        ...
                        @if (array_key_exists('Pengelolaan Data Pribadi Pegawai', $modul) ||
                                ...
                                array_key_exists('Rekap SDM', $modul))
                            ...
                            @if (array_key_exists('Pengelolaan Data Pribadi Pegawai', $modul) ||
                                ...
                                <li @if (
                                    $menu == 'Melihat Data Diri' ||
                                        ...
                                        $menu == 'Curriculum Vitae') class="mm-active" @endif>
                                    <a class="has-arrow material-ripple" href="#">
                                        <i class="typcn typcn-th-list mr-2"></i>
                                        Data Kepegawaian
                                    </a>
                                    <ul class="nav-second-level">
                                        ...
                                        @if (array_key_exists('Pengelolaan Data Kepegawaian', $modul))
                                            <li @if (
                                                $menu == 'List Data Pegawai - HRD' ||
                                                    $menu == 'Detail Data Pegawai - HRD' ||
                                                    $menu == 'Edit Data Pegawai - HRD' ||
                                                    $menu == 'Create Data Pegawai - HRD') class="mm-active" @endif>
                                        ...
                                        @if (array_key_exists('Curriculum Vitae', $modul))
                                            <li @if ($menu == 'Curriculum Vitae') class="mm-active" @endif>
                                                <a href="{{ route('dosen.cv.curriculum_vitae.index') }}">Curriculum
                                                    Vitae</a>
                                            </li>
                                        @endif
                                    </ul>
                                    ...
                                    <ul class="nav-second-level">
                                        @if (array_key_exists('Rekap SDM', $modul))
                                            ...
                                            <li @if ($menu == 'Rekap SDM - Dosen Tidak Tetap') class="mm-active" @endif>
                                                <a href="{{ route('hrd_page.rekap_sdm.dosen_tidak_tetap') }}">Dosen
                                                    Tidak
                                                    Tetap</a>
                                            </li>
                        ...
                        @if (array_key_exists('Melihat Hasil Kuesioner Kepuasan Wisudawan', $modul) ||
                                array_key_exists('Melihat Hasil Kuesioner Kepuasan Mahasiswa', $modul))
                            ...
                            <li @if ($menu == 'Melihat Hasil Kuesioner Kepuasan Wisudawan') class="mm-active" @endif>
                                ...
                                <ul class="nav-second-level">
                                    @if (array_key_exists('Melihat Hasil Kuesioner Kepuasan Wisudawan', $modul))
                                        <li @if ($menu == 'Melihat Hasil Kuesioner Kepuasan Wisudawan') class="mm-active" @endif>
                                            <a
                                                href="{{ route('bpm_page.kuesioner.kuesioner_kepuasan_wisudawan.hasil_kuesioner.index') }}">Hasil
                                                Kuesioner</a>
                                        </li>
                                    @endif
                                </ul>
                            ...
                            <li @if ($menu == 'Melihat Hasil Kuesioner Kepuasan Mahasiswa') class="mm-active" @endif>
                                ...
                                <ul class="nav-second-level">
                                    @if (array_key_exists('Melihat Hasil Kuesioner Kepuasan Mahasiswa', $modul))
                                        <li @if ($menu == 'Melihat Hasil Kuesioner Kepuasan Mahasiswa') class="mm-active" @endif>
                                            <a
                                                href="{{ route('bpm_page.kuesioner.kuesioner_kepuasan_mahasiswa.hasil_kuesioner.index') }}">Hasil
                                                Kuesioner</a>
                                        </li>
                                    @endif
                                </ul>
                        ...
                        @if (
                            ...
                            array_key_exists('Pengelolaan Surat', $modul) || array_key_exists('Pengajuan Surat', $modul))
                                ...
                                <ul class="nav-second-level">
                                    @if (array_key_exists('Melihat Surat', $modul))
                                        <li @if ($menu == 'Melihat Surat') class="mm-active" @endif>
                                            <a href="{{ route('karyawan.surat_menyurat.surat.index') }}">Arsip
                                                Surat</a>
                                        </li>
                                    @endif
                        ...
                        @if (array_key_exists('Pengelolaan Gaji Bulanan', $modul) ||
                                ...
                                array_key_exists('Moodle Synchronizer - Suspended Mahasiswa', $modul) ||
                                array_key_exists('Melihat Data Tanggungan Mahasiswa Siakad', $modul) ||
                        ...
                        @if (array_key_exists('Pengelolaan Gaji Bulanan', $modul) ||
                                array_key_exists('Pengaturan Gaji', $modul) ||
                                array_key_exists('Gaji Pokok', $modul) ||
                                array_key_exists('Melihat Gaji Bulanan', $modul) ||
                                array_key_exists('Melihat Honorarium Mengajar', $modul) ||
                                array_key_exists('Melihat Honorarium Koreksi', $modul))
                            <li
                                class="{{ in_array($menu, [
                                    'Pengelolaan Gaji Bulanan',
                                    'Gaji Pokok',
                                    'Pengaturan Gaji - Daftar Pegawai',
                                    'Pengaturan Gaji - Gaji Umum',
                                    'Pengaturan Gaji - Potongan BPJS',
                                    'Pengaturan Gaji - Potongan Koperasi',
                                    'Pengaturan Gaji - Potongan Arisan',
                                    'Pengaturan Gaji - Potongan Qurban',
                                    'Pengaturan Gaji - Potongan Lainnya',
                                    'Melihat Gaji Bulanan',
                                    'Pengelolaan Honorarium Mengajar',
                                    'Pengelolaan Honorarium Koreksi',
                                    'Pengelolaan Honorarium Pengawas',
                                    'Melihat Honorarium Mengajar',
                                    'Melihat Honorarium Koreksi',
                                    'Pengaturan Gaji - Insentif Lainnya',
                                    'Pengaturan Gaji - Daftar Tunjangan Fungsional',
                                ])
                                    ? 'mm-active'
                                    : '' }}">
                                ...
                                <ul class="nav-second-level">
                                    {{-- Menu: Melihat Honorarium --}}
                                    @if (array_key_exists('Melihat Honorarium Mengajar', $modul) || array_key_exists('Melihat Honorarium Koreksi', $modul))
                                        <li
                                            class="{{ in_array($menu, ['Melihat Honorarium Mengajar', 'Melihat Honorarium Koreksi']) ? 'mm-active' : '' }}">
                                            ...
                                            <ul class="nav-third-level mm-collapse">
                                                @if (array_key_exists('Melihat Honorarium Mengajar', $modul))
                                                    <li
                                                        class="{{ $menu == 'Melihat Honorarium Mengajar' ? 'mm-active' : '' }}">
                                                        <a
                                                            href="{{ route('dosen_page.keuangan.honorarium.honorarium_mengajar.index') }}">Mengajar</a>
                                                    </li>
                                                @endif

                                                @if (array_key_exists('Melihat Honorarium Koreksi', $modul))
                                                    <li
                                                        class="{{ $menu == 'Melihat Honorarium Koreksi' ? 'mm-active' : '' }}">
                                                        <a
                                                            href="{{ route('dosen_page.keuangan.honorarium.honorarium_koreksi.index') }}">Koreksi</a>
                                                    </li>
                                                @endif
                                            </ul>
                                        </li>
                                    ...
                                    @if (array_key_exists('Melihat Gaji Bulanan', $modul))
                                        <li class="{{ $menu == 'Melihat Gaji Bulanan' ? 'mm-active' : '' }}">
                                    ...
                                    @if (array_key_exists('Pengelolaan Gaji Bulanan', $modul))
                                        <li class="{{ $menu == 'Pengelolaan Gaji Bulanan' ? 'mm-active' : '' }}">
                                            <a href="{{ route('keuangan.penggajian.gaji_bulanan.index') }}">Gaji
                                                Bulanan</a>
                                        </li>
                                    @endif

                                    {{-- Menu: Pengelolaan Honorarium --}}
                                    @if (array_key_exists('Pengelolaan Honorarium Mengajar', $modul) ||
                                            array_key_exists('Pengelolaan Honorarium Koreksi', $modul) ||
                                            array_key_exists('Pengelolaan Honorarium Pengawas', $modul))
                                        <li
                                            class="{{ in_array($menu, ['Pengelolaan Honorarium Mengajar', 'Pengelolaan Honorarium Koreksi', 'Pengelolaan Honorarium Pengawas']) ? 'mm-active' : '' }}">
                                            <a
                                                href="@if (array_key_exists('Pengelolaan Honorarium Mengajar', $modul)) {{ route('keuangan.penggajian.honorarium.honorarium_mengajar.index') }}
                             @elseif(array_key_exists('Pengelolaan Honorarium Koreksi', $modul)) {{ route('keuangan.penggajian.honorarium.honorarium_koreksi.index') }}
                             @else {{ route('keuangan.penggajian.honorarium.honorarium_pengawas.index') }} @endif">
                                                Honorarium
                                            </a>
                                        </li>
                                    @endif
                                    ...
                                    @if (array_key_exists('Pengaturan Gaji', $modul))
                                        <li
                                            class="{{ in_array($menu, ['Pengaturan Gaji - Daftar Pegawai', 'Pengaturan Gaji - Gaji Umum', 'Pengaturan Gaji - Potongan Koperasi', 'Pengaturan Gaji - Potongan BPJS', 'Pengaturan Gaji - Insentif Lainnya', 'Pengaturan Gaji - Daftar Tunjangan Fungsional']) ? 'mm-active' : '' }}">
                                            <a
                                                href="{{ route('keuangan.penggajian.pengaturan_gaji.daftar_pegawai.index') }}">Pengaturan
                                                Gaji</a>
                                        </li>
                                    @endif
                        ...
                        @if (array_key_exists('Moodle Synchronizer - Suspended Mahasiswa', $modul) ||
                            ...
                            <li @if (
                                $menu == 'Suspended Mahasiswa | Moodle' ||
                                    $menu == 'Tanggungan Mahasiswa | Siakad' ||
                                    $menu == 'Keuangan - Melihat Daftar Mahasiswa Siakad') class="mm-active" @endif>
                                <a class="has-arrow material-ripple" href="#">
                                    <i class="typcn typcn-th-list mr-2"></i>
                                    Mahasiswa
                                </a>
                        ...
                        @if (array_key_exists('Pengisian SPI', $modul) ||
                                array_key_exists('Validasi Pengajuan Sertifikat Laboratorium Komputer', $modul) ||
                                array_key_exists('Pengelolaan Nomor Sertifikat', $modul) ||
                                array_key_exists('Pengajuan Sertifikat Laboratorium Komputer', $modul) ||
                                array_key_exists('Melihat Rekap Absensi Mengajar', $modul) ||
                                array_key_exists('Pengelolaan Rekap Absensi Mengajar', $modul) ||
                                array_key_exists('Pengelolaan Jadwal Wisuda', $modul) ||
                                array_key_exists('Validasi Pendaftaran Wisuda', $modul) ||
                                array_key_exists('Pengelolaan Mahasiswa LP3I Banyuwangi', $modul) ||
                                array_key_exists('Pengajuan Tugas Akhir', $modul) ||
                                ...
                                <ul class="nav-second-level">
                                    @if (array_key_exists('Validasi Pengajuan Sertifikat Laboratorium Komputer', $modul))
                                        <li @if ($menu == 'Validasi Pengajuan Sertifikat Laboratorium Komputer') class="mm-active" @endif>
                                            <a
                                                href="{{ route('akademik.sertifikat_labkom.validasi.pengajuan_sertifikat') }}">Sertifikat
                                                Labkom</a>
                                        </li>
                                    @endif
                                    @if (array_key_exists('Student Body', $modul))
                                        <li @if ($menu == 'Student Body') class="mm-active" @endif>
                                            <a
                                                href="{{ route('admin_akademik.akademik.mahasiswa.student_body.index') }}">Student
                                                Body</a>
                                        </li>
                                    @endif
                                    @if (array_key_exists('Pengelolaan Nomor Sertifikat', $modul))
                                        <li @if ($menu == 'Pengelolaan Nomor Sertifikat') class="mm-active" @endif>
                                            <a href="{{ route('akademik.nomor_sertifikat.index') }}">Nomor
                                                Sertifikat</a>
                                        </li>
                                    @endif
                                    @if (array_key_exists('Pengisian SPI', $modul))
                                            ...
                                            <ul class="nav-third-level mm-collapse" style="">
                                                @if (array_key_exists('Sinkronisasi Tahun Akademik dengan Siakad', $modul))
                                                    <li @if ($menu == 'Sinkronisasi Tahun Akademik dengan Siakad') class="mm-active" @endif>
                                                        <a
                                                            href="{{ route('admin_akademik.akademik.perkuliahan.sinkronisasi_tahun_akademik_siakad.index') }}">Tahun
                                                            Akademik</a>
                                                    </li>
                                                @endif
                                    ...
                                    <ul class="nav-third-level mm-collapse" style="">
                                        ...
                                        @if (array_key_exists('Validasi Pendaftaran Wisuda', $modul))
                                            <li @if ($menu == 'Validasi Pendaftaran Wisuda') class="mm-active" @endif>
                                                <a
                                                    href="{{ route('admin_akademik.akademik.wisuda.pendaftaran_wisuda.index') }}">Pendaftaran
                                                    Wisuda</a>
                                            </li>
                                        @endif
                                    </ul>
                            ...
                            @endif --}}
                                    @if (session()->has('nilai_ta') || session()->has('krs_ta'))
                                        @if (array_key_exists('Pengajuan Tugas Akhir', $modul))
                                            <li @if ($menu == 'Pengajuan Tugas Akhir') class="mm-active" @endif>
                                                <a
                                                    href="{{ route('mahasiswa.akademik.pengajuan_tugas_akhir.index') }}">Tugas
                                                    Akhir</a>
                                            </li>
                                        @endif
                                    @endif
                                    @if (session()->has('nilai_ta'))
                                        @if (array_key_exists('Pendaftaran Wisuda', $modul))
                                            <li @if ($menu == 'Pendaftaran Wisuda') class="mm-active" @endif>
                                                <a
                                                    href="{{ route('mahasiswa.akademik.pendaftaran_wisuda.index') }}">Wisuda</a>
                                            </li>
                                        @endif
                                    @endif
                                    ...
                                    @if (array_key_exists('Persetujuan Transkrip Nilai', $modul))
                                        <li @if ($menu == 'Persetujuan Transkrip Nilai') class="mm-active" @endif>
                                            @if (\Illuminate\Support\Facades\Session::get('peran')['aktif'] == 69)
                                                <a href="{{ route('kaprodi.akademik.transkrip.index') }}">Pengajuan
                                                    Transkrip</a>
                                    ...
                                    @if (array_key_exists('Pengajuan Jurnal Mengajar Dosen', $modul))
                                        <li @if ($menu == 'Pengajuan Jurnal Mengajar Dosen') class="mm-active" @endif>
                                            <a href="{{ route('kaprodi.pengajuan_jurnal_mengajar_dosen.index') }}">Jurnal
                                                Mengajar Dosen</a>
                                        </li>
                                    @endif
                                </ul>
                                ...
                                <ul class="nav-second-level">
                                    ...
                                    @if (array_key_exists('Pengelolaan Jenis Pelaksanaan Kuliah', $modul))
                                        <li @if ($menu == 'Pengelolaan Jenis Pelaksanaan Kuliah') class="mm-active" @endif>
                                            <a href="{{ route('jenis_pelaksanaan_kuliah.index') }}">Jenis Pelaksanaan
                                                Kuliah</a>
                                        </li>
                                    @endif
                                    @if (array_key_exists('Pengelolaan Jenis Pengajaran', $modul))
                                        <li @if ($menu == 'Pengelolaan Jenis Pengajaran') class="mm-active" @endif>
                                            <a href="{{ route('jenis_pengajaran.index') }}">Jenis Pengajaran</a>
                                        </li>
                                    @endif
                                    @if (array_key_exists('Manajemen Ruangan', $modul))
                                        <li @if ($menu == 'Manajemen Ruangan') class="mm-active" @endif>
                                            <a href="{{ route('manajemen_ruangan.index') }}">Manajemen Ruangan</a>
                                        </li>
                                    @endif
                            ...
                            <li @if ($menu == 'Manajemen Kelas Perkuliahan' || $menu == 'Ploting Matakuliah') class="mm-active" @endif>
                                ...
                                <ul class="nav-second-level">
                                    ...
                                    @if (array_key_exists('Ploting Matakuliah', $modul))
                                        <li @if ($menu == 'Ploting Matakuliah') class="mm-active" @endif>
                                            <a href="{{ route('plotting_perkuliahan.index') }}">Ploting
                                                Matakuliah</a>
                                        </li>
                                    @endif
                                </ul>
                        ...
                        @if (array_key_exists('Syncron Program Studi', $modul) ||
                                array_key_exists('Syncron Mahasiswa', $modul) ||
                                array_key_exists('Syncron Dosen', $modul))
                                ...
                                <ul class="nav-second-level">
                                    ...
                                    @if (array_key_exists('Syncron Mahasiswa', $modul))
                                        <li @if ($menu == 'Syncron Mahasiswa') class="mm-active" @endif>
                                            <a
                                                href="{{ route('sinkronisasi_data.mahasiswa.mahasiswa') }}">Mahasiswa</a>
                                        </li>
                                    @endif
                        ...
                        @if (array_key_exists('Pengelolaan Aplikasi Mandala', $modul) ||
                                array_key_exists('Pengelolaan Modul Aplikasi', $modul) ||
                                array_key_exists('Pengelolaan Peran Aplikasi', $modul) ||
                                array_key_exists('Pengelolaan Kewenangan Peran', $modul))
                        ...
                        @if (array_key_exists('Pengelolaan Aplikasi Mandala', $modul) ||
                                ...
                                array_key_exists('Pengelolaan Peran Aplikasi', $modul) ||
                                array_key_exists('Pengelolaan Kewenangan Peran', $modul) ||
                                array_key_exists('Pengelolaan Peran Pengguna', $modul))
                            <li @if (
                                $menu == 'Pengelolaan Aplikasi Mandala' ||
                                    ...
                                    $menu == 'Pengelolaan Peran Pengguna') class="mm-active" @endif>
                                <a class="has-arrow material-ripple" href="#">
                                    <i class="typcn typcn-th-list mr-2"></i>
                                    Konfigurasi Sistem
                                </a>
                        ...
                        @if (array_key_exists('Melihat Data Perkuliahan Siakad', $modul) ||
                                array_key_exists('Melihat Data Mahasiswa Siakad', $modul) ||
                                array_key_exists('Melihat Data Dosen/Karyawan Siakad', $modul) ||
                                array_key_exists('Moodle Synchronizer - Jadwal Siakad', $modul) ||
                                array_key_exists('Melihat Data Perkuliahan Mahasiswa Siakad', $modul) ||
                        ...
                        @if (array_key_exists('Melihat Data Perkuliahan Siakad', $modul) ||
                            ...
                            <li @if (
                                $menu == 'Jadwal Dosen | Siakad' ||
                                    ...
                                    $menu == 'Dosen | Siakad' ||
                                    $menu == 'Jadwal Mahasiswa | Siakad') class="mm-active" @endif>
                                <a class="has-arrow material-ripple" href="#">
                                    <i class="typcn typcn-th-list mr-2"></i>
                                    Siakad
                                </a>
                                <ul class="nav-second-level">
                                    ...
                                    @if (array_key_exists('Melihat Data Perkuliahan Siakad', $modul))
                                        <li @if ($menu == 'Jadwal Dosen | Siakad') class="mm-active" @endif>
                                            <a href="{{ route('siakad.jadwal_perkuliahan.vwJadwalDosen') }}">Jadwal
                                                Dosen</a>
                                        </li>
                                    @endif
                        ...
                        @if (array_key_exists('Moodle Synchronizer - Jadwal Siakad', $modul) ||
                            ...
                            <li style="display: none" @if (
                                $menu == 'Jadwal Dosen | Moodle' ||
                                    ...
                                    $menu == 'Dosen | Moodle' ||
                                    $menu == 'Jadwal Mahasiswa | Moodle') class="mm-active" @endif>
                                <a class="has-arrow material-ripple" href="#">
                                    <i class="typcn typcn-th-list mr-2"></i>
                                    Moodle
                                </a>
                                <ul class="nav-second-level">
                                    ...
                                    @if (array_key_exists('Moodle Synchronizer - Mahasiswa', $modul))
                                        <li @if ($menu == 'Mahasiswa | Moodle') class="mm-active" @endif>
                                            ...
                                            <ul class="nav-third-level mm-collapse" style="">
                                                @if (array_key_exists('Moodle Synchronizer - Mahasiswa', $modul))
                                                    <li @if ($menu == 'Mahasiswa | Moodle') class="mm-active" @endif>
                                                        <a href="{{ route('moodle.mahasiswa.index') }}"
                                    ...
                                    @if (array_key_exists('Moodle Synchronizer - Jadwal Mahasiswa', $modul))
                                        <li @if ($menu == 'Jadwal Mahasiswa | Moodle') class="mm-active" @endif>
                                            <a href="{{ route('moodle.jadwal_mahasiswa.index') }}">Jadwal
                                                Mahasiswa</a>
                                        </li>
                                    @endif
                                </ul>
                        ...
                        @if (!isset(\Illuminate\Support\Facades\Session::get('user')->id_mhs))
                            <li style="display: none"><a target="_blank"
                                    ...
                                    class="btn btn-warning-soft mt-2"><i
                                        class="typcn typcn-download mr-2"></i>Peraturan
                                    Disiplin</a>
                            </li>
                        @endif
                    </ul>
                    ...
                    <div class="d-flex flex-grow-1">
                        ...
                        <ul class="navbar-nav flex-row align-items-center m-0">
                                    ...
                                    <div class="notification-list"
                                        ...
                                        @foreach (\Illuminate\Support\Facades\Session::get('peran')['all'] as $item)
                                            <div class="media new peran" data-id_peran="{{ $item->id_peran }}">
                                                <div class="img-user">
                                                    <img src="{{ asset('adminpage/assets/dist/img/avatar.png') }}"
                                                        alt="">
                                                </div>
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <div class="user-header">
                                        ...
                                        <p class="text-center mb-0 text-capitalize">
                                            ...
                                            @if (isset(\Illuminate\Support\Facades\Session::get('user')->id_mhs))
                                                <small class="d-block text-muted">NIM:
                                                    {{ \Illuminate\Support\Facades\Session::get('user')->nim }}</small>
                                            @endif
                                        </p>
                                    </div><!-- user-header -->
                            ...
                            @endif --}}
                                    ...
                                    <a href="{{ route('account.password') }}" class="dropdown-item"><i
                                            class="typcn typcn-cog mr-2"></i>Ganti Password</a>
                        ...
                        <div class="modal-dialog modal-md" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn btn-success" id="btn-ubah-password">Ubah
                                        Password
                                    </button>
                                </div>
                            </div>
