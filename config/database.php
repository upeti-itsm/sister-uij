    ...
    'connections' => [
       ...
       'siakad' => [
        ...
        'emane' => [
            'driver' => 'pgsql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST_MOODLE', '127.0.0.1'),
            'port' => env('DB_PORT_MOODLE', '5432'),
            'database' => env('DB_DATABASE_MOODLE', 'forge'),
            'username' => env('DB_USERNAME_MOODLE', 'forge'),
            'password' => env('DB_PASSWORD_MOODLE', ''),
            'charset' => 'utf8',
            'prefix' => '',
            'prefix_indexes' => true,
            'schema' => 'public',
