...
Route::post('/adm-akademik/akademik/perkuliahan/tahun-akademik/insup-tahun-akademik', [\App\Http\Controllers\AdminAkademikPage\Akademik\Matakuliah\SemesterController::class, 'insup_tahun_akademik'])->name('admin_akademik.akademik.perkuliahan.insup.tahun_akademik')->middleware('modul:Sinkronisasi Tahun Akademik dengan Siakad');
Route::post('/adm-akademik/akademik/perkuliahan/tahun-akademik/toggle-status', [\App\Http\Controllers\AdminAkademikPage\Akademik\Matakuliah\SemesterController::class, 'toggle_status'])->name('admin_akademik.akademik.perkuliahan.tahun_akademik.toggle_status')->middleware('modul:Sinkronisasi Tahun Akademik dengan Siakad');
...
Route::post('/adm-akademik/akademik/perkuliahan/sinkronisasi-jadwal-kuliah-siakad/generate-jadwal', [\App\Http\Controllers\AdminAkademikPage\Akademik\Matakuliah\JadwalMatakuliahController::class, 'generate_jadwal'])->name('admin_akademik.akademik.jadwal_kuliah.sinkronisasi_jadwal_kuliah_siakad.generate_jadwal')->middleware('modul:Sinkronisasi Jadwal Kuliah dengan Siakad');
Route::post('/adm-akademik/akademik/perkuliahan/sinkronisasi-jadwal-kuliah-siakad/insert', [\App\Http\Controllers\AdminAkademikPage\Akademik\Matakuliah\JadwalMatakuliahController::class, 'insert_jadwal'])->name('admin_akademik.akademik.jadwal_kuliah.sinkronisasi_jadwal_kuliah_siakad.insert_jadwal')->middleware('modul:Sinkronisasi Jadwal Kuliah dengan Siakad');
Route::post('/adm-akademik/akademik/perkuliahan/sinkronisasi-jadwal-kuliah-siakad/update', [\App\Http\Controllers\AdminAkademikPage\Akademik\Matakuliah\JadwalMatakuliahController::class, 'update_jadwal'])->name('admin_akademik.akademik.jadwal_kuliah.sinkronisasi_jadwal_kuliah_siakad.update_jadwal')->middleware('modul:Sinkronisasi Jadwal Kuliah dengan Siakad');
Route::post('/adm-akademik/akademik/perkuliahan/sinkronisasi-jadwal-kuliah-siakad/delete', [\App\Http\Controllers\AdminAkademikPage\Akademik\Matakuliah\JadwalMatakuliahController::class, 'delete_jadwal'])->name('admin_akademik.akademik.jadwal_kuliah.sinkronisasi_jadwal_kuliah_siakad.delete_jadwal')->middleware('modul:Sinkronisasi Jadwal Kuliah dengan Siakad');
Route::post('/adm-akademik/akademik/perkuliahan/sinkronisasi-jadwal-kuliah-siakad/set-status-aktif', [\App\Http\Controllers\AdminAkademikPage\Akademik\Matakuliah\JadwalMatakuliahController::class, 'set_status_aktif'])->name('admin_akademik.akademik.jadwal_kuliah.sinkronisasi_jadwal_kuliah_siakad.set_status_aktif')->middleware('modul:Sinkronisasi Jadwal Kuliah dengan Siakad');
Route::post('/adm-akademik/akademik/perkuliahan/sinkronisasi-jadwal-kuliah-siakad/update-status-kuliah-mahasiswa', [\App\Http\Controllers\AdminAkademikPage\Akademik\Matakuliah\JadwalMatakuliahController::class, 'update_status_kuliah_mahasiswa'])->name('admin_akademik.akademik.jadwal_kuliah.sinkronisasi_jadwal_kuliah_siakad.update_status_kuliah_mahasiswa')->middleware('modul:Sinkronisasi Jadwal Kuliah dengan Siakad');
// Jadwal Mahasiswa
...
Route::get('/adm-akademik/akademik/perkuliahan/ip-presensi-perkuliahan', [\App\Http\Controllers\AdminAkademikPage\Akademik\Matakuliah\IpPresensiPerkuliahanController::class, 'index'])->name('admin_akademik.akademik.jadwal_kuliah.ip_presensi_perkuliahan.index')->middleware('modul:IP Presensi Perkuliahan');
Route::post('/adm-akademik/akademik/perkuliahan/ip-presensi-perkuliahan/json', [\App\Http\Controllers\AdminAkademikPage\Akademik\Matakuliah\IpPresensiPerkuliahanController::class, 'json'])->name('admin_akademik.akademik.jadwal_kuliah.ip_presensi_perkuliahan.json')->middleware('modul:IP Presensi Perkuliahan');
Route::post('/adm-akademik/akademik/perkuliahan/ip-presensi-perkuliahan/store-update', [\App\Http\Controllers\AdminAkademikPage\Akademik\Matakuliah\IpPresensiPerkuliahanController::class, 'insup'])->name('admin_akademik.akademik.jadwal_kuliah.ip_presensi_perkuliahan.store_update')->middleware('modul:IP Presensi Perkuliahan');
Route::post('/adm-akademik/akademik/perkuliahan/ip-presensi-perkuliahan/delete', [\App\Http\Controllers\AdminAkademikPage\Akademik\Matakuliah\IpPresensiPerkuliahanController::class, 'delete'])->name('admin_akademik.akademik.jadwal_kuliah.ip_presensi_perkuliahan.delete')->middleware('modul:IP Presensi Perkuliahan');

// Kurikulum
Route::get('/adm-akademik/akademik/kurikulum', [\App\Http\Controllers\AdminAkademikPage\Akademik\KurikulumController::class, 'index'])->name('kurikulum.index')->middleware('modul:Manajemen Kurikulum');
Route::post('/adm-akademik/akademik/kurikulum/json', [\App\Http\Controllers\AdminAkademikPage\Akademik\KurikulumController::class, 'json'])->name('kurikulum.json')->middleware('modul:Manajemen Kurikulum');
Route::post('/adm-akademik/akademik/kurikulum/store', [\App\Http\Controllers\AdminAkademikPage\Akademik\KurikulumController::class, 'store'])->name('kurikulum.store')->middleware('modul:Manajemen Kurikulum');
Route::post('/adm-akademik/akademik/kurikulum/update', [\App\Http\Controllers\AdminAkademikPage\Akademik\KurikulumController::class, 'update'])->name('kurikulum.update')->middleware('modul:Manajemen Kurikulum');
Route::post('/adm-akademik/akademik/kurikulum/delete', [\App\Http\Controllers\AdminAkademikPage\Akademik\KurikulumController::class, 'delete'])->name('kurikulum.delete')->middleware('modul:Manajemen Kurikulum');

// Jenis Matakuliah
Route::get('/adm-akademik/perkuliahan/jenis-matakuliah', [\App\Http\Controllers\AdminAkademikPage\Perkuliahan\JenisMatakuliahCont::class, 'index'])->name('jenis_matakuliah.index')->middleware('modul:Pengelolaan Jenis Matakuliah');
Route::post('/adm-akademik/perkuliahan/jenis-matakuliah/json', [\App\Http\Controllers\AdminAkademikPage\Perkuliahan\JenisMatakuliahCont::class, 'json'])->name('jenis_matakuliah.json')->middleware('modul:Pengelolaan Jenis Matakuliah');
Route::post('/adm-akademik/perkuliahan/jenis-matakuliah/store', [\App\Http\Controllers\AdminAkademikPage\Perkuliahan\JenisMatakuliahCont::class, 'store'])->name('jenis_matakuliah.store')->middleware('modul:Pengelolaan Jenis Matakuliah');
Route::post('/adm-akademik/perkuliahan/jenis-matakuliah/update', [\App\Http\Controllers\AdminAkademikPage\Perkuliahan\JenisMatakuliahCont::class, 'update'])->name('jenis_matakuliah.update')->middleware('modul:Pengelolaan Jenis Matakuliah');
Route::post('/adm-akademik/perkuliahan/jenis-matakuliah/delete', [\App\Http\Controllers\AdminAkademikPage\Perkuliahan\JenisMatakuliahCont::class, 'delete'])->name('jenis_matakuliah.delete')->middleware('modul:Pengelolaan Jenis Matakuliah');

// Jenis Pelaksanaan Kuliah
Route::get('/adm-akademik/perkuliahan/jenis-pelaksanaan-kuliah', [\App\Http\Controllers\AdminAkademikPage\Perkuliahan\JenisPelaksanaanKuliahCont::class, 'index'])->name('jenis_pelaksanaan_kuliah.index')->middleware('modul:Pengelolaan Jenis Pelaksanaan Kuliah');
Route::post('/adm-akademik/perkuliahan/jenis-pelaksanaan-kuliah/json', [\App\Http\Controllers\AdminAkademikPage\Perkuliahan\JenisPelaksanaanKuliahCont::class, 'json'])->name('jenis_pelaksanaan_kuliah.json')->middleware('modul:Pengelolaan Jenis Pelaksanaan Kuliah');
Route::post('/adm-akademik/perkuliahan/jenis-pelaksanaan-kuliah/store', [\App\Http\Controllers\AdminAkademikPage\Perkuliahan\JenisPelaksanaanKuliahCont::class, 'store'])->name('jenis_pelaksanaan_kuliah.store')->middleware('modul:Pengelolaan Jenis Pelaksanaan Kuliah');
Route::post('/adm-akademik/perkuliahan/jenis-pelaksanaan-kuliah/update', [\App\Http\Controllers\AdminAkademikPage\Perkuliahan\JenisPelaksanaanKuliahCont::class, 'update'])->name('jenis_pelaksanaan_kuliah.update')->middleware('modul:Pengelolaan Jenis Pelaksanaan Kuliah');
Route::post('/adm-akademik/perkuliahan/jenis-pelaksanaan-kuliah/delete', [\App\Http\Controllers\AdminAkademikPage\Perkuliahan\JenisPelaksanaanKuliahCont::class, 'delete'])->name('jenis_pelaksanaan_kuliah.delete')->middleware('modul:Pengelolaan Jenis Pelaksanaan Kuliah');
...
// Pengaturan SKS
Route::get('/adm-akademik/perkuliahan/pengaturan-sks', [\App\Http\Controllers\AdminAkademikPage\Perkuliahan\PengaturanSKSController::class, 'index'])->name('pengaturan_sks.index')->middleware('modul:Pengaturan SKS');
Route::post('/adm-akademik/perkuliahan/pengaturan-sks/json', [\App\Http\Controllers\AdminAkademikPage\Perkuliahan\PengaturanSKSController::class, 'json'])->name('pengaturan_sks.json')->middleware('modul:Pengaturan SKS');
Route::post('/adm-akademik/perkuliahan/pengaturan-sks/store', [\App\Http\Controllers\AdminAkademikPage\Perkuliahan\PengaturanSKSController::class, 'store'])->name('pengaturan_sks.store')->middleware('modul:Pengaturan SKS');
...
Route::post('/adm-akadmik/perkuliahan/matakuliah/json-by-kurikulum', [\App\Http\Controllers\AdminAkademikPage\Perkuliahan\MatakuliahCont::class, 'json_matakuliah_by_kurikulum'])->name('matakuliah.json_matakuliah_by_kurikulum')->middleware('modul:Pengelolaan Matakuliah');
Route::post('/adm-akadmik/perkuliahan/matakuliah/json-kurikulum-by-prodi', [\App\Http\Controllers\AdminAkademikPage\Perkuliahan\MatakuliahCont::class, 'json_kurikulum_by_prodi'])->name('matakuliah.json_kurikulum_by_prodi')->middleware('modul:Pengelolaan Matakuliah');
Route::post('/adm-akadmik/perkuliahan/matakuliah/json-konsentrasi-by-prodi', [\App\Http\Controllers\AdminAkademikPage\Perkuliahan\MatakuliahCont::class, 'json_konsentrasi_by_prodi'])->name('matakuliah.json_konsentrasi_by_prodi')->middleware('modul:Pengelolaan Matakuliah');
...
Route::post('/adm-akademik/plotting/plotting-kelas/import', [\App\Http\Controllers\AdminAkademikPage\Plotting\PlottingPerkuliahanController::class, 'import'])->name('plotting_perkuliahan.import')->middleware('modul:Ploting Matakuliah');
...
Route::post('/mhs/krs/json-draft', [\App\Http\Controllers\MahasiswaPage\Akademik\KRSController::class, 'json_draft'])->name('mahasiswa.akademik.krs.json_draft')->middleware('modul:Mengelola Kartu Rencana Studi');
...
Route::get('/dosen/akademik/rekapitulasi-absen-mengajar/presensi/{id}', [\App\Http\Controllers\DosenPage\Akadmik\RekapitulasiAbsenMengajarController::class, 'presensi_mahasiswa'])->name('dosen.akademik.rekapitulasi_absen_mengajar.presensi_mahasiswa')->middleware('modul:Melihat Rekap Absensi Mengajar');
Route::post('/dosen/akademik/rekapitulasi-absen-mengajar/presensi/json', [\App\Http\Controllers\DosenPage\Akadmik\RekapitulasiAbsenMengajarController::class, 'json_presensi_mahasiswa'])->name('dosen.akademik.rekapitulasi_absen_mengajar.json_presensi_mahasiswa')->middleware('modul:Melihat Rekap Absensi Mengajar');
Route::post('/dosen/akademik/rekapitulasi-absen-mengajar/presensi/store', [\App\Http\Controllers\DosenPage\Akadmik\RekapitulasiAbsenMengajarController::class, 'update_presensi_mahasiswa'])->name('dosen.akademik.rekapitulasi_absen_mengajar.update_presensi_mahasiswa')->middleware('modul:Melihat Rekap Absensi Mengajar');
// Daftar Matakuliah
...
Route::get('/dosen/akademik/daftar-matakuliah/export-presensi/{id}', [\App\Http\Controllers\DosenPage\Akadmik\MatakuliahController::class, 'export_presensi_mahasiswa'])->name('dosen.akademik.daftar_matakuliah.export_presensi_mahasiswa')->middleware('modul:Dosen - Daftar Matakuliah');
Route::post('/dosen/akademik/daftar-matakuliah/json-kriteria', [\App\Http\Controllers\DosenPage\Akadmik\MatakuliahController::class, 'json_kriteria_penilaian'])->name('dosen.akademik.daftar_matakuliah.json_kriteria_penilaian')->middleware('modul:Dosen - Daftar Matakuliah');
Route::post('/dosen/akademik/daftar-matakuliah/json-kriteria-store', [\App\Http\Controllers\DosenPage\Akadmik\MatakuliahController::class, 'json_kriteria_penilaian_store'])->name('dosen.akademik.daftar_matakuliah.json_kriteria_penilaian_store')->middleware('modul:Dosen - Daftar Matakuliah');
...
Route::get('/keu/penggajian/pengaturan-gaji/gaji-pokok', [\App\Http\Controllers\KeuanganPage\Penggajian\PengaturanGaji\PengaturanGajiPokokController::class, 'index'])->name('keuangan.penggajian.pengaturan_gaji.gaji_pokok.index')->middleware('modul:Pengaturan Gaji');
Route::post('/keu/penggajian/pengaturan-gaji/gaji-pokok/data', [\App\Http\Controllers\KeuanganPage\Penggajian\PengaturanGaji\PengaturanGajiPokokController::class, 'get_data'])->name('keuangan.penggajian.pengaturan_gaji.gaji_pokok.get_data')->middleware('modul:Pengaturan Gaji');
Route::post('/keu/penggajian/pengaturan-gaji/gaji-pokok/update', [\App\Http\Controllers\KeuanganPage\Penggajian\PengaturanGaji\PengaturanGajiPokokController::class, 'update_nominal'])->name('keuangan.penggajian.pengaturan_gaji.gaji_pokok.update')->middleware('modul:Pengaturan Gaji');
Route::post('/keu/penggajian/pengaturan-gaji/gaji-pokok/set-status', [\App\Http\Controllers\KeuanganPage\Penggajian\PengaturanGaji\PengaturanGajiPokokController::class, 'set_status'])->name('keuangan.penggajian.pengaturan_gaji.gaji_pokok.set_status')->middleware('modul:Pengaturan Gaji');
Route::post('/keu/penggajian/pengaturan-gaji/gaji-pokok/jenis-karyawan', [\App\Http\Controllers\KeuanganPage\Penggajian\PengaturanGaji\PengaturanGajiPokokController::class, 'get_jenis_karyawan'])->name('keuangan.penggajian.pengaturan_gaji.gaji_pokok.get_jenis_karyawan')->middleware('modul:Pengaturan Gaji');
Route::post('/keu/penggajian/pengaturan-gaji/gaji-pokok/pendidikan', [\App\Http\Controllers\KeuanganPage\Penggajian\PengaturanGaji\PengaturanGajiPokokController::class, 'get_pendidikan'])->name('keuangan.penggajian.pengaturan_gaji.gaji_pokok.get_pendidikan')->middleware('modul:Pengaturan Gaji');
Route::post('/keu/penggajian/pengaturan-gaji/gaji-pokok/insert', [\App\Http\Controllers\KeuanganPage\Penggajian\PengaturanGaji\PengaturanGajiPokokController::class, 'insert_nominal'])->name('keuangan.penggajian.pengaturan_gaji.gaji_pokok.insert')->middleware('modul:Pengaturan Gaji');
...
// Insentif Lainnya
Route::get('/keu/penggajian/pengaturan-gaji/insentif-lainnya', [\App\Http\Controllers\KeuanganPage\Penggajian\PengaturanGaji\InsentifLainnyaController::class, 'index'])->name('keuangan.penggajian.pengaturan_gaji.insentif_lainnya.index')->middleware('modul:Pengaturan Gaji');
Route::post('/keu/penggajian/pengaturan-gaji/insentif-lainnya/json', [\App\Http\Controllers\KeuanganPage\Penggajian\PengaturanGaji\InsentifLainnyaController::class, 'json_get_daftar_insentif_lainnya'])->name('keuangan.penggajian.pengaturan_gaji.insentif_lainnya.json_get_daftar_insentif_lainnya')->middleware('modul:Pengaturan Gaji');
Route::post('/keu/penggajian/pengaturan-gaji/insentif-lainnya/upload', [\App\Http\Controllers\KeuanganPage\Penggajian\PengaturanGaji\InsentifLainnyaController::class, 'upload'])->name('keuangan.penggajian.pengaturan_gaji.insentif_lainnya.upload')->middleware('modul:Pengaturan Gaji');
Route::post('/keu/penggajian/pengaturan-gaji/insentif-lainnya/insert', [\App\Http\Controllers\KeuanganPage\Penggajian\PengaturanGaji\InsentifLainnyaController::class, 'insert_insentif'])->name('keuangan.penggajian.pengaturan_gaji.insentif_lainnya.insert_insentif')->middleware('modul:Pengaturan Gaji');
Route::get('/keu/penggajian/pengaturan-gaji/insentif-lainnya/detail/{bulan}/{tahun}', [\App\Http\Controllers\KeuanganPage\Penggajian\PengaturanGaji\InsentifLainnyaController::class, 'get_detail_insentif'])->name('keuangan.penggajian.pengaturan_gaji.insentif_lainnya.get_detail_insentif')->middleware('modul:Pengaturan Gaji');
Route::post('/keu/penggajian/pengaturan-gaji/insentif-lainnya/detail/json', [\App\Http\Controllers\KeuanganPage\Penggajian\PengaturanGaji\InsentifLainnyaController::class, 'json_get_detail_insentif_lainnya'])->name('keuangan.penggajian.pengaturan_gaji.insentif_lainnya.json_get_detail_insentif_lainnya')->middleware('modul:Pengaturan Gaji');
Route::post('/keu/penggajian/pengaturan-gaji/insentif-lainnya/detail/update', [\App\Http\Controllers\KeuanganPage\Penggajian\PengaturanGaji\InsentifLainnyaController::class, 'update_insentif'])->name('keuangan.penggajian.pengaturan_gaji.insentif_lainnya.update_insentif')->middleware('modul:Pengaturan Gaji');
Route::post('/keu/penggajian/pengaturan-gaji/insentif-lainnya/detail/delete', [\App\Http\Controllers\KeuanganPage\Penggajian\PengaturanGaji\InsentifLainnyaController::class, 'delete_insentif'])->name('keuangan.penggajian.pengaturan_gaji.insentif_lainnya.delete_insentif')->middleware('modul:Pengaturan Gaji');
Route::get('/keu/penggajian/pengaturan-gaji/insentif-lainnya/export/pdf/{bulan}/{tahun}', [\App\Http\Controllers\KeuanganPage\Penggajian\PengaturanGaji\InsentifLainnyaController::class, 'export_pdf_detail_insentif'])->name('keuangan.penggajian.pengaturan_gaji.insentif_lainnya.export_pdf_detail_insentif')->middleware('modul:Pengaturan Gaji');
...
// Pengaturan Transportasi S2
Route::get('/keu/penggajian/pengaturan-gaji/pengaturan-transportasi', [\App\Http\Controllers\KeuanganPage\Penggajian\PengaturanGaji\PengaturanTransportasiController::class, 'index'])->name('keuangan.penggajian.pengaturan_gaji.pengaturan_transportasi.index')->middleware('modul:Pengaturan Gaji');
...
Route::post('/keu/penggajian/pengaturan-gaji/tunjangan-kinerja/delete', [\App\Http\Controllers\KeuanganPage\Penggajian\PengaturanGaji\DaftarTunjanganKinerjaController::class, 'delete'])->name('keuangan.penggajian.pengaturan_gaji.daftar_tunjangan_kinerja.delete')->middleware('modul:Pengaturan Gaji');
...
Route::post('/keu/penggajian/pengaturan-gaji/tunjangan-fungsional/upsert', [\App\Http\Controllers\KeuanganPage\Penggajian\PengaturanGaji\DaftarTunjanganFungsionalController::class, 'insup'])->name('keuangan.penggajian.pengaturan_gaji.daftar_tunjangan_fungsional.insup')->middleware('modul:Pengaturan Gaji');
Route::post('/keu/penggajian/pengaturan-gaji/tunjangan-fungsional/set-active', [\App\Http\Controllers\KeuanganPage\Penggajian\PengaturanGaji\DaftarTunjanganFungsionalController::class, 'set_active'])->name('keuangan.penggajian.pengaturan_gaji.daftar_tunjangan_fungsional.set_active')->middleware('modul:Pengaturan Gaji');
// Honorarium Mengajar
