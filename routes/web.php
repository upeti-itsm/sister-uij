...
Route::get('/keu/penggajian/pengaturan-gaji/gaji-pokok', [\App\Http\Controllers\KeuanganPage\Penggajian\PengaturanGaji\GajiPokokController::class, 'index'])->name('keuangan.penggajian.pengaturan_gaji.gaji_pokok.index')->middleware('modul:Pengaturan Gaji');
Route::post('/keu/penggajian/pengaturan-gaji/gaji-pokok/data', [\App\Http\Controllers\KeuanganPage\Penggajian\PengaturanGaji\GajiPokokController::class, 'get_data'])->name('keuangan.penggajian.pengaturan_gaji.gaji_pokok.get_data')->middleware('modul:Pengaturan Gaji');
Route::post('/keu/penggajian/pengaturan-gaji/gaji-pokok/update', [\App\Http\Controllers\KeuanganPage\Penggajian\PengaturanGaji\GajiPokokController::class, 'update_nominal'])->name('keuangan.penggajian.pengaturan_gaji.gaji_pokok.update')->middleware('modul:Pengaturan Gaji');
Route::post('/keu/penggajian/pengaturan-gaji/gaji-pokok/set-status', [\App\Http\Controllers\KeuanganPage\Penggajian\PengaturanGaji\GajiPokokController::class, 'set_status'])->name('keuangan.penggajian.pengaturan_gaji.gaji_pokok.set_status')->middleware('modul:Pengaturan Gaji');
Route::post('/keu/penggajian/pengaturan-gaji/gaji-pokok/jenis-karyawan', [\App\Http\Controllers\KeuanganPage\Penggajian\PengaturanGaji\GajiPokokController::class, 'get_jenis_karyawan'])->name('keuangan.penggajian.pengaturan_gaji.gaji_pokok.get_jenis_karyawan')->middleware('modul:Pengaturan Gaji');
Route::post('/keu/penggajian/pengaturan-gaji/gaji-pokok/pendidikan', [\App\Http\Controllers\KeuanganPage\Penggajian\PengaturanGaji\GajiPokokController::class, 'get_pendidikan'])->name('keuangan.penggajian.pengaturan_gaji.gaji_pokok.get_pendidikan')->middleware('modul:Pengaturan Gaji');
Route::post('/keu/penggajian/pengaturan-gaji/gaji-pokok/insert', [\App\Http\Controllers\KeuanganPage\Penggajian\PengaturanGaji\GajiPokokController::class, 'insert_nominal'])->name('keuangan.penggajian.pengaturan_gaji.gaji_pokok.insert')->middleware('modul:Pengaturan Gaji');
