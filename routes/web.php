...
Route::get('//dosen/akademik/rekapitulasi-absen-mengajar/presensi/{id}', [\App\Http\Controllers\DosenPage\Akadmik\RekapitulasiAbsenMengajarController::class, 'index'])->name('dosen.akademik.rekapitulasi_absen_mengajar.presensi_mahasiswa')->middleware('modul:Melihat Rekap Absensi Mengajar');
// Daftar Matakuliah
