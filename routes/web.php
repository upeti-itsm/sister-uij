...
Route::get('/dosen/akademik/rekapitulasi-absen-mengajar/presensi/json', [\App\Http\Controllers\DosenPage\Akadmik\RekapitulasiAbsenMengajarController::class, 'json_presensi_mahasiswa'])->name('dosen.akademik.rekapitulasi_absen_mengajar.json_presensi_mahasiswa')->middleware('modul:Melihat Rekap Absensi Mengajar');
// Daftar Matakuliah
