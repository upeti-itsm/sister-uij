jQuery.list_doc_author = {
    ...
    setEvents: function () {
        ...
        self.data.table = $("#table").DataTable({
            serverSide: true,
            ajax: {
                url: '/lppm/sinta/list-books-json',
                type: 'post',
                data: function (data) {
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function (data) {
                        return "<b>" + data.publisher + "</b><hr/>" +
                            "<span class='badge badge-danger-soft mr-2'>" + data.place + "<br/><small>Place</small></span>" +
                            "<span class='badge badge-success-soft mr-2'>" + data.year + "<br/><small>Publish Year</small></span>" +
                            "<span class='badge badge-info-soft mr-2'>" + data.isbn + "<br/><small>ISBN</small></span>";
                    }
                },
                {
                    data: null,
    ...
    next_data: function (data, id_sinta, index = 0, progres = 0, failed = 0, inserted = 0) {
        ...
        var n = data.length;
        $.ajax({
            url: '/lppm/sinta/store-books-json',
            method: 'post',
            data: {
                'id_sinta': id_sinta,
