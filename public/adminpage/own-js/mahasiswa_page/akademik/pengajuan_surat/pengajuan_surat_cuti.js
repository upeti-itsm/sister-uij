jQuery.pengajuanSurat = {
    ...
    initTable: function () {
        ...
        self.data.table = $('#table-pengajuan-surat').DataTable({
            ...
            searching: false,
            ajax: {
                url: '/mhs/pengajuan-surat-cuti/json',
                type: 'POST',
                beforeSend: function () {
    ...
    bindEvents: function () {
        ...
        $('#form-pengajuan-surat').on('submit', function (e) {
            ...
            $.ajax({
                url: '/mhs/pengajuan-surat-cuti/store',
                method: 'POST',
                data: $(this).serialize(),
            ...
            $.confirm({
                ...
                buttons: {
                    ...
                    confirm: {
                        ...
                        action: function () {
                            $.ajax({
                                url: '/mhs/pengajuan-surat-cuti/delete',
                                method: 'POST',
                                data: {
        ...
        $('#table-pengajuan-surat').on('click', '.btn-download', function () {
            window.open('/mhs/pengajuan-surat-cuti/download/' + $(this).data('id'), '_blank');
        });
    },
