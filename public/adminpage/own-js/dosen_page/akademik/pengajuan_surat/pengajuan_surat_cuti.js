jQuery.pengajuanSuratDosen = {
    ...
    initTable: function () {
        ...
        self.data.table = $('#table-pengajuan-surat-dosen').DataTable({
            ...
            searching: false,
            ajax: {
                url: '/dosen/pengajuan-surat-cuti/json',
                type: 'POST',
                beforeSend: function () {
    ...
    bindEvents: function () {
        ...
        $('#table-pengajuan-surat-dosen').on('click', '.btn-detail-dosen', function () {
            ...
            $.ajax({
                url: '/dosen/pengajuan-surat-cuti/detail',
                method: 'POST',
                ...
                success: function (response) {
                    if (response.status === '1') {
                        ...
                        $('#detail-dosen-tahun-akademik').text(d.tahun_akademik || '-');
            ...
            $.confirm({
                ...
                buttons: {
                    ...
                    confirm: {
                        ...
                        action: function () {
                            $.ajax({
                                url: '/dosen/pengajuan-surat-cuti/approve',
                                method: 'POST',
                                data: { _token: $('meta[name="csrf-token"]').attr('content'), id_pengajuan: currentId },
                                success: function (response) {
                                    if (response.status === '1') {
                    ...
                    buttons: {
                        ...
                        confirm: {
                            ...
                            action: function () {
                                ...
                                $.ajax({
                                    url: '/dosen/pengajuan-surat-cuti/reject',
                                    method: 'POST',
                                    data: {
...
$(document).ready(function () {
    if ($('#table-pengajuan-surat-dosen').length) {
        jQuery.pengajuanSuratDosen.init();
    }
});
