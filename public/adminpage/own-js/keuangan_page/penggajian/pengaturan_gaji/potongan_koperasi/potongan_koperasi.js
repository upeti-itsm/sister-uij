jQuery.potongan_koperasi = {
    ...
    setEvents: function () {
        ...
        self.data.table = $("#table").DataTable({
            serverSide: true,
            ajax: {
                url: '/keu/penggajian/pengaturan-gaji/potongan-koperasi/json',
                type: 'post',
                data: function (data) {
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function (data) {
                        return "<p><b>" + data.informasi_potongan_koperasi + "</b>" +
                            "</p>";
                    }
                },
                {
                ...
                },
                {
                    ...
                    width: "30%",
                    render: function (data) {
                        return "<a class='btn btn-primary btn-sm mr-2' title='Detail Peserta' href='/keu/penggajian/pengaturan-gaji/potongan-koperasi/detail/" + data.periode_rekap + "/" + data.tahun + "'><i class='fas fa-eye mr-2'></i>Detail</a>" +
                            "<a target='_blank' class='btn btn-danger btn-sm' title='Export Peserta' href='/keu/penggajian/pengaturan-gaji/potongan-koperasi/export/pdf/" + data.periode_rekap + "/" + data.tahun + "'><i class='fas fa-file-pdf mr-2'></i>Download</a>";
                    }
                }
            ],
            paging: true,
                    ...
                    buttons: {
                        confirm: {
                            ...
                            action: function () {
                                ...
                                $.ajax({
                                    url: '/keu/penggajian/pengaturan-gaji/potongan-koperasi/upload',
                                    type: 'POST',
                                    data: formData,
    ...
    next_data: function (data, periode, tahun, index = 0, progres = 0, failed = 0, inserted = 0) {
        ...
        var n = data.length;
        $.ajax({
            url: '/keu/penggajian/pengaturan-gaji/potongan-koperasi/insert',
            method: 'post',
            data: {
