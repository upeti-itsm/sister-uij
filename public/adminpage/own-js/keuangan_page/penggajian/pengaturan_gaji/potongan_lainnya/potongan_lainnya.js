jQuery.potongan_lainnya = {
    ...
    setEvents: function () {
        ...
        $("#btn_upload_potongan").click(function () {
            $("#modal-upload-potongan-lainnya").modal('show');
        });

        self.data.table = $("#table").DataTable({
            serverSide: true,
            ajax: {
                url: '/keu/penggajian/pengaturan-gaji/potongan-lainnya/json',
                type: 'post',
                data: function (data) {
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function (data) {
                        return "<p><b>" + data.informasi_potongan_lainnya + "</b>" +
                            "</p>";
                    }
                },
                {
                ...
                },
                {
                    ...
                    width: "30%",
                    render: function (data) {
                        return "<a class='btn btn-primary btn-sm mr-2' title='Detail Potongan' href='/keu/penggajian/pengaturan-gaji/potongan-lainnya/detail/" + data.periode_rekap + "/" + data.tahun + "'><i class='fas fa-eye mr-2'></i>Detail</a>" +
                            "<a target='_blank' class='btn btn-danger btn-sm' title='Export Peserta' href='/keu/penggajian/pengaturan-gaji/potongan-lainnya/export/pdf/" + data.periode_rekap + "/" + data.tahun + "'><i class='fas fa-file-pdf mr-2'></i>Download</a>";
                    }
                }
            ],
            paging: true,
                    ...
                    buttons: {
                        confirm: {
                            ...
                            action: function () {
                                ...
                                $.ajax({
                                    url: '/keu/penggajian/pengaturan-gaji/potongan-lainnya/upload',
                                    type: 'POST',
                                    data: formData,
    ...
    next_data: function (data, periode, tahun, index = 0, progres = 0, failed = 0, inserted = 0) {
        ...
        var n = data.length;
        $.ajax({
            url: '/keu/penggajian/pengaturan-gaji/potongan-lainnya/insert',
            method: 'post',
            data: {
