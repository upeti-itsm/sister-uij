jQuery.pengaturan_transportasi = {
    data: {
        table: $("#table"),
        number: $(".number"),
    },
    ...
    setEvents: function () {
        ...
        self.data.table = $("#table").DataTable({
            serverSide: true,
            ajax: {
                url: '/keu/penggajian/pengaturan-gaji/pengaturan-transportasi/json',
                type: 'post'
            },
            scrollY: '400px',
            scrollCollapse: true,
            columns: [
                ...
                },
                {
                    ...
                    width: "10%",
                    render: function (data) {
                        return "<button class='btn btn-success btn-edit mr-2' data-id='" + data.id_jabatan_fungsional + "' data-jabatan_fungsional='" + data.jabatan_fungsional + "' title='Ubah Nominal Transportasi S2' data-nominal='" + data.nominal + "'><i class='fas fa-edit'></i></button>";
                    }
                }
            ],
            paging: true,
...
jQuery(document).ready(function () {
    jQuery.pengaturan_transportasi.init();
});
