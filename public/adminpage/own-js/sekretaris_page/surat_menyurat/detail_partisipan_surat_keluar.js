jQuery.detail_partisipan_surat_keluar = {
    data: {
        table: $("#table"),
    },
    init: function () {
    ...
    setEvents: function () {
        ...
        self.data.table = $("#table").DataTable({
            serverSide: true,
            ajax: {
                url: '/sek/surat-menyurat/surat-keluar-masuk/json/detail/surat-keluar',
                type: 'post',
                data: function (data) {
                    data.id_surat = $("#id_surat_keluar").val();
                }
            },
            scrollY: '400px',
            scrollCollapse: true,
            ...
            $.confirm({
                ...
                buttons: {
                    confirm: {
                        ...
                        action: function () {
                            $.ajax({
                                url: '/sek/surat-menyurat/surat-keluar-masuk/json/add/surat-keluar',
                                method: 'POST',
                                data: {
                                    id_surat: $("#id_surat_keluar").val(),
            ...
            $.confirm({
                ...
                buttons: {
                    confirm: {
                        ...
                        action: function () {
                            $.ajax({
                                url: '/sek/surat-menyurat/surat-keluar-masuk/json/delete/surat-keluar',
                                method: 'POST',
                                data: {
                                    id_surat: $("#id_surat_keluar").val(),
                                    id_personal: id
...
jQuery(document).ready(function () {
    jQuery.detail_partisipan_surat_keluar.init();
});
