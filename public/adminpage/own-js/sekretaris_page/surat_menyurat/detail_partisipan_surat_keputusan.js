jQuery.detail_partisipan_surat_keputusan = {
    data: {
        table: $("#table"),
    },
    init: function () {
    ...
    setEvents: function () {
        ...
        self.data.table = $("#table").DataTable({
            serverSide: true,
            ajax: {
                url: '/sek/surat-menyurat/surat-keputusan/json/detail-partisipan',
                type: 'post',
                data: function (data) {
                    data.id_sk = $("#id_sk").val();
                }
            },
            scrollY: '400px',
            scrollCollapse: true,
        ...
        $("#btn-tambah-data").click(function () {
            $.confirm({
                ...
                type: 'orange',
                columnClass: 'medium',
                content: 'Apakah anda yakin menambahkan akses ' + $("#pengakses option:selected").text() + ' ke Arsip SK ini ?',
                buttons: {
                    confirm: {
                        text: 'Yakin',
                        btnClass: 'btn-green',
                        ...
                        action: function () {
                            $.ajax({
                                url: '/sek/surat-menyurat/surat-keputusan/json/add-partisipan',
                                method: 'POST',
                                data: {
                                    id_sk: $("#id_sk").val(),
        ...
        $("#table").on('click', 'button.btn-delete', function () {
            ...
            $.confirm({
                ...
                type: 'orange',
                columnClass: 'medium',
                content: 'Apakah anda yakin menghapus akses yang bersangkutan dari Arsip SK ini ?',
                buttons: {
                    confirm: {
                        text: 'Yakin',
                        btnClass: 'btn-green',
                        ...
                        action: function () {
                            $.ajax({
                                url: '/sek/surat-menyurat/surat-keputusan/json/delete-partisipan',
                                method: 'POST',
                                data: {
                                    id_sk: $("#id_sk").val(),
                                    id_personal: id
...
jQuery(document).ready(function () {
    jQuery.detail_partisipan_surat_keputusan.init();
});
