...
class HonorariumKoreksiController extends Controller
{
    public static function index(){
        $menu = "Melihat Honorarium Koreksi";
        ...
        return view('dosen_page.keuangan.honorarium_koreksi.daftar', compact('menu', 'bulan', 'tahun'));
    }
    ...
    public function json(Request $request)
    {
        ...
        $data_ = HonorariumKoreksi::get_daftar_honorarium_koreksi(Session::get('user')->id_personal, $request->bulan, $request->tahun, $search, $start, $length);
    ...
    public function detail($id_honorarium)
    {
        ...
        $menu = "Melihat Honorarium Koreksi";
        return view('dosen_page.keuangan.honorarium_koreksi.detail', compact('menu', 'rekap', 'karyawan', 'id_honorarium'));
    }
    ...
    public function slip_gaji($id_honorarium)
    {
        ...
        $data['rekap'] = $rekap;
        $pdf = Facade::loadView("dosen_page.keuangan.honorarium_koreksi.slip", compact('data'))->setPaper('letter', 'portrait');
    ...
    public function ajukan_perbaikan(Request $request){
        ...
        $rekap = HonorariumKoreksi::set_pengajuan_perbaikan_honor_koreksi($request->id, true, $request->keterangan);
