...
class PengajuanSuratAktifDosenController extends Controller
{
    public function index()
    {
        $menu = 'Persetujuan Surat Aktif';
        return view('dosen_page.akademik.pengajuan_surat.pengajuan_surat_aktif', compact('menu'));
    }
    ...
    public function json(Request $request)
    {
        try {
            ...
            $result = PengajuanSurat::get_list_aktif_dosen($idPersonal, $status, $search, $start, $length);
    ...
    public function approve(Request $request)
    {
        try {
            ...
            $result = PengajuanSurat::set_status_aktif($idRiwayat, '2', $idPersonal, null);
    ...
    public function reject(Request $request)
    {
        try {
            ...
            $result = PengajuanSurat::set_status_aktif($idRiwayat, '3', $idPersonal, $catatan);
