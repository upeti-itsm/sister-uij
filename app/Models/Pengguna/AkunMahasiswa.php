...
class AkunMahasiswa extends Model
{
    ...
    {
        return DB::select('select * from pengguna.set_autentikasi_v2(:username, :password, :ip, :id_app)', [
    ...
    {
        return DB::select('select * from pengguna.check_sertifikat_mahasiswa(:id_sertifikat, :id_mhs, :id_app)', [
            'id_sertifikat' => $sertifikat,
            'id_mhs' => $id_mhs,
            'id_app' => '7d7c0b9a-6c3b-4b75-ab50-9b74877b860a',
        ]);
    }
    ...
    {
        return DB::select('select * from pengguna.list_peran_by_mahasiswa(:id_mhs, :id_app)', [
            'id_mhs' => $id_mhs,
            'id_app' => '7d7c0b9a-6c3b-4b75-ab50-9b74877b860a',
        ]);
    }
    ...
    {
        return DB::select('select * from akademik.get_profil_mahasiswa_by_nim(:nim)', [
            'nim' => $nim,
        ]);
    }
}
