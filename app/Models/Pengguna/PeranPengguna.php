...
class PeranPengguna extends Model
{
    ...
    public static function add_peran_pengguna($id_personal, $id_peran, $is_default, $unit_kerja = null)
    {
        return DB::select('SELECT * FROM pengguna.add_peran_pengguna(:id_personal, :id_peran, :is_default, :unit_kerja)', [
            'id_personal' => $id_personal,
            'id_peran' => $id_peran,
