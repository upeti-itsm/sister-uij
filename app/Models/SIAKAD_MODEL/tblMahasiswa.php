...
class tblMahasiswa extends Model
{
    ...
    {
        return DB::connection('siakad')->select("SELECT DISTINCT t1.thnakademikmasuk FROM akademik.mahasiswa t1 ORDER BY t1.thnakademikmasuk DESC");
    }
    ...
    {
        if ($angkatan == "all") {
            return DB::connection('siakad')->select("select distinct t1.nim, null as nisn, t2.idstafdosen as p_dosen_wali, thnlulus as p_tanggal_lulus_slta, null as p_inf_jurusan_sma, t5.namaslta as p_sekolah_asal, null as p_inf_tgl_lulus, null as p_nomor_ijazah, null p_inf_nomor_transkrip, t11.kdstatusakademik as p_sts_aktif, t1.kdprogramstudi as p_program_id, null as p_konsentrasi_id, t3.namaayah as p_nama_wali, null as p_pekerjaan_wali, null as p_jenis_mahasiswa, null as p_jenis_pendanaan, null as p_nomor_seri_ijazah, t4.nama as p_nama_lengkap, t6.kota as p_tempat_lahir, t4.tgllahir as p_tanggal_lahir, t7.jeniskelamin as p_jenis_kelamin, t8.agama as p_agama, null as p_status_menikah, t4.nohp as p_no_hp, t3.notelportu as p_telepon_rumah, t4.alamattinggal as p_alamat_rumah, t4.kdposalamattinggal as p_kd_pos, t9.warganegara as p_inf_warga_negara, t3.email as p_email, null as p_nik, t3.rt as p_rt, t3.rw as p_rw, t3.kelurahan as p_kelurahan, t4.namaibukandung as p_nama_ibu, t12.pswd as p_password, t1.thnakademikmasuk as p_tahun_angkatan, null as p_jenis_kelas, null as p_ipk, t10.kota as p_kota_rumah, t13.namaprogramstudi as p_nama_program, '-' as p_judul_skripsi from akademik.mahasiswa t1 left join akademik.perwalian t2 using(nim) left join akademik.identitasmahasiswas0_s1 t3 using(nim) left join person.identitas t4 using(idpersonal) left join support.slta t5 on t3.idslta = t5.kdslta left join support.kota t6 on t4.idkotalahir = t6.idkota left join support.jeniskelamin t7 using(kdjeniskelamin) left join support.agama t8 using(kdagama) left join support.warganegara t9 using(kdwarganegara) left join support.kota t10 on t3.idkotaortu = t10.idkota left join akademik.statusakademikmahasiswa t11 on t1.nim = t11.nim left join usersystem.idusersystem t12 on t1.idpersonal = t12.idpersonal left join support.programstudi t13 on t1.kdprogramstudi = t13.kdprogramstudi where t11.kdstatusakademik = 'A'");
        } else {
            return DB::connection('siakad')->select("select distinct t1.nim, null as nisn, t2.idstafdosen as p_dosen_wali, thnlulus as p_tanggal_lulus_slta, null as p_inf_jurusan_sma, t5.namaslta as p_sekolah_asal, null as p_inf_tgl_lulus, null as p_nomor_ijazah, null p_inf_nomor_transkrip, t11.kdstatusakademik as p_sts_aktif, t1.kdprogramstudi as p_program_id, null as p_konsentrasi_id, t3.namaayah as p_nama_wali, null as p_pekerjaan_wali, null as p_jenis_mahasiswa, null as p_jenis_pendanaan, null as p_nomor_seri_ijazah, t4.nama as p_nama_lengkap, t6.kota as p_tempat_lahir, t4.tgllahir as p_tanggal_lahir, t7.jeniskelamin as p_jenis_kelamin, t8.agama as p_agama, null as p_status_menikah, t4.nohp as p_no_hp, t3.notelportu as p_telepon_rumah, t4.alamattinggal as p_alamat_rumah, t4.kdposalamattinggal as p_kd_pos, t9.warganegara as p_inf_warga_negara, t3.email as p_email, null as p_nik, t3.rt as p_rt, t3.rw as p_rw, t3.kelurahan as p_kelurahan, t4.namaibukandung as p_nama_ibu, t12.pswd as p_password, t1.thnakademikmasuk as p_tahun_angkatan, null as p_jenis_kelas, null as p_ipk, t10.kota as p_kota_rumah, t13.namaprogramstudi as p_nama_program, '-' as p_judul_skripsi from akademik.mahasiswa t1 left join akademik.perwalian t2 using(nim) left join akademik.identitasmahasiswas0_s1 t3 using(nim) left join person.identitas t4 using(idpersonal) left join support.slta t5 on t3.idslta = t5.kdslta left join support.kota t6 on t4.idkotalahir = t6.idkota left join support.jeniskelamin t7 using(kdjeniskelamin) left join support.agama t8 using(kdagama) left join support.warganegara t9 using(kdwarganegara) left join support.kota t10 on t3.idkotaortu = t10.idkota left join akademik.statusakademikmahasiswa t11 on t1.nim = t11.nim left join usersystem.idusersystem t12 on t1.idpersonal = t12.idpersonal left join support.programstudi t13 on t1.kdprogramstudi = t13.kdprogramstudi where t11.kdstatusakademik = 'A' and t1.thnakademikmasuk = ?", [
                $angkatan
            ]);
        }
    }
    ...
    {
        return DB::connection('siakad')->select("select distinct t1.nim, null as nisn, t15.nomorpegawai as p_dosen_wali, thnlulus as p_tanggal_lulus_slta, null as p_inf_jurusan_sma, t5.namaslta as p_sekolah_asal, null as p_inf_tgl_lulus, null as p_nomor_ijazah, null p_inf_nomor_transkrip, t11.kdstatusakademik as p_sts_aktif, t1.kdprogramstudi as p_program_id, null as p_konsentrasi_id, t3.namaayah as p_nama_wali, null as p_pekerjaan_wali, null as p_jenis_mahasiswa, null as p_jenis_pendanaan, null as p_nomor_seri_ijazah, t4.nama as p_nama_lengkap, t6.kota as p_tempat_lahir, t4.tgllahir as p_tanggal_lahir, t7.jeniskelamin as p_jenis_kelamin, t8.agama as p_agama, null as p_status_menikah, t4.nohp as p_no_hp, t3.notelportu as p_telepon_rumah, t4.alamattinggal as p_alamat_rumah, t4.kdposalamattinggal as p_kd_pos, t9.warganegara as p_inf_warga_negara, t3.email as p_email, null as p_nik, t3.rt as p_rt, t3.rw as p_rw, t3.kelurahan as p_kelurahan, t4.namaibukandung as p_nama_ibu, t12.pswd as p_password, t1.thnakademikmasuk as p_tahun_angkatan, null as p_jenis_kelas, null as p_ipk, t10.kota as p_kota_rumah, t13.namaprogramstudi as p_nama_program, '-' as p_judul_skripsi from akademik.mahasiswa t1 left join akademik.perwalian t2 using(nim) left join akademik.identitasmahasiswas0_s1 t3 using(nim) left join person.identitas t4 using(idpersonal) left join support.slta t5 on t3.idslta = t5.kdslta left join support.kota t6 on t4.idkotalahir = t6.idkota left join support.jeniskelamin t7 using(kdjeniskelamin) left join support.agama t8 using(kdagama) left join support.warganegara t9 using(kdwarganegara) left join support.kota t10 on t3.idkotaortu = t10.idkota left join akademik.statusakademikmahasiswa t11 on t1.nim = t11.nim left join usersystem.idusersystem t12 on t1.idpersonal = t12.idpersonal left join support.programstudi t13 on t1.kdprogramstudi = t13.kdprogramstudi left join staf.stafdosen t14 on t2.idstafdosen = t14.idstafdosen inner join staf.pegawai t15 on t14.idpegawai = t15.idpegawai where t11.kdstatusakademik = 'A' and t1.thnakademikmasuk = ?", [
            $angkatan
        ]);
    }
